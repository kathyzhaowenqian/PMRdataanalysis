...
def get_compmany_default_value():
    return Company.objects.get(id=10).company

class NXUserInfo(UserInfo):   
...
class NXSalesmanPosition(models.Model):
    # id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('NXUserInfo', models.CASCADE, db_column='user',to_field='id') #settings.AUTH_USER_MODEL
...
class NXSPDList(models.Model):
    # id = models.BigAutoField(primary_key=True)
    company = models.ForeignKey('Company', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_compmany_default_value)
    salesman = models.ForeignKey('NXUserInfo', models.CASCADE, db_column='salesman',to_field='id',related_name='salesmanNX',verbose_name= '负责人')
    ...
    operator = models.ForeignKey('NXUserInfo', models.CASCADE, db_column='operator',to_field='id',related_name='operatorNX',verbose_name= '最后操作人')   
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now=True)
    is_active=models.BooleanField(verbose_name='是否呈现',null=False, default = True)
...
class NXOverall(models.Model):
    ...
    company = models.ForeignKey('Company', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_compmany_default_value)
    salesman = models.ForeignKey('NXUserInfo', models.CASCADE, db_column='salesman',to_field='id',related_name='salesmanNXoverall',verbose_name= '负责人',default=7)
    ...
    operator = models.ForeignKey('NXUserInfo', models.CASCADE, db_column='operator',to_field='id',related_name='operatorNXoverall',verbose_name= '最后操作人')   
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now=True)
    is_active=models.BooleanField(verbose_name='是否呈现',null=False, default = True)
...
#新项目---------------------
class NXNewProjectStatus(models.Model):
    ...
    progress_choices = (
        ...
        ('仪器装机启用', '仪器装机启用'),
        ('仪器试剂均开票','仪器试剂均开票'))
    overallid = models.ForeignKey('NXOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
...
class NXNewProjectDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXNewProjectStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class NXNegotiationStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class NXNegotiationDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXNegotiationStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class NXChangeChannelStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class NXChangeChannelDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXChangeChannelStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class NXChangeBrandStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
#品牌替换前
class NXBeforeChangeBrandDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXChangeBrandStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
#品牌替换后
class NXAfterChangeBrandDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXChangeBrandStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class NXSetStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class NXSetDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('NXSetStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
#=====================================
class NXCalculate(models.Model):
    overallid = models.OneToOneField('NXOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
...
#========
#普中心大菜单给供应商重新谈判的筛选用的
class NXMenu(models.Model):
    overallid = models.ForeignKey('NXOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=0)
    ...
    purchaseqty = models.DecimalField(verbose_name='1-6月销售数量',max_digits=25, decimal_places=2,default = 0)
...
#普中心大菜单给inline展示用的
class NXMenuforinline(models.Model):
    overallid = models.ForeignKey('NXOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=1)
