...
from NANXIANG.models_delete import *
...
#----------FORM-------LIST--------
class NXOverallForm(forms.ModelForm):
...
class NXNewProjectDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXNewProjectDetail
            exclude = ['id']
            widgets = {
...
class NXNegotiationDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # print('aaaaaaaaaaaaaaaaaaaaaaaaaaa')
        self.fields['productid'].queryset =  NXMenu.objects.filter(is_active=True)

    class Meta: 
            model = NXNegotiationDetail
            exclude = ['id']
            widgets = {
...
class NXChangeChannelDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  NXMenu.objects.filter(is_active=True)

    class Meta: 
            model = NXChangeChannelDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class NXBeforeChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  NXMenu.objects.filter(is_active=True)

    class Meta: 
            model = NXBeforeChangeBrandDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class NXAfterChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXAfterChangeBrandDetail
            exclude = ['id']
            widgets = {
                'originalsupplier': forms.TextInput(attrs={'size':'10'}),
                'originalbrand': forms.TextInput(attrs={'size':'5'}),
...
class NXSetDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class NXNewProjectStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXNewProjectStatus
            exclude = ['id']
            widgets = {
...
class NXNegotiationStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXNegotiationStatus
            exclude = ['id']
            widgets = {
...
class NXChangeChannelStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXChangeChannelStatus
            exclude = ['id']
            widgets = {
...
class NXChangeBrandStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = NXChangeBrandStatus
            exclude = ['id']
            widgets = {
...
class NXSetStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class NXMenuforinlineInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
#---------------------------------------------------------------
#新开项目明细的内嵌inline
class NXNewProjectDetailInline(nested_admin.NestedTabularInline):
    form=NXNewProjectDetailInlineForm
    model = NXNewProjectDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('NXNewProjectDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNewProjectDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXNewProjectDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNewProjectDetailInline has change permission:::obj',False)
            return False
        
#新开项目状态的内嵌inline
class NXNewProjectStatusInline(nested_admin.NestedStackedInline):
    form=NXNewProjectStatusInlineForm
    inlines=[NXNewProjectDetailInline]
    model = NXNewProjectStatus
    # fk_name = "overallid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('NXNewProjectStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNewProjectStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXNewProjectStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNewProjectStatusInline has change permission:::obj',False)
            return False

#----------------------------------------------------------------
#供应商重新谈判明细的内嵌inline
class NXNegotiationDetailInline(nested_admin.NestedTabularInline):
    form=NXNegotiationDetailInlineForm
    model = NXNegotiationDetail
    extra = 0
    ...
    def get_queryset(self, request):
       ...
       #普通销售的话:
        ...
        # return qs.filter((Q(is_active=True)&Q(researchlist__salesman1=request.user))|(Q(is_active=True)&Q(researchlist__salesman2=request.user)))
    def has_add_permission(self,request,obj):
        print('NXNegotiationDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNegotiationDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXNegotiationDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNegotiationDetailInline has change permission:::obj',False)
            return False

#供应商重新谈判状态的内嵌inline
class NXNegotiationStatusInline(nested_admin.NestedStackedInline):
    form=NXNegotiationStatusInlineForm
    inlines=[NXNegotiationDetailInline]
    model = NXNegotiationStatus
    fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('NXNegotiationStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNegotiationStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXNegotiationStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXNegotiationStatusInline has change permission:::obj',False)
            return False
#----------------------------------------------------------------
#渠道变更明细的内嵌inline
class NXChangeChannelDetailInline(nested_admin.NestedTabularInline):
    form=NXChangeChannelDetailInlineForm
    model = NXChangeChannelDetail
    # fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_recentsales','field_recentcost','field_recentgp','field_recentgpofsupplier','field_estmonthlygpgrowth')#'field_lissettleprice') 
    ...
    def has_add_permission(self,request,obj):
        print('NXChangeChannelDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXChangeChannelDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXChangeChannelDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXChangeChannelDetailInline has change permission:::obj',False)
            return False

#渠道变更状态的内嵌inline
class NXChangeChannelStatusInline(nested_admin.NestedStackedInline):
    form=NXChangeChannelStatusInlineForm
    inlines=[NXChangeChannelDetailInline]
    model = NXChangeChannelStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('NXChangeChannelStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXChangeChannelStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXChangeChannelStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXChangeChannelStatusInline has change permission:::obj',False)
            return False
#-----------------------------------------------------------------
#品牌替换前明细的内嵌inline
class NXBeforeChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=NXBeforeChangeBrandDetailInlineForm
    model = NXBeforeChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('NXBeforeChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXBeforeChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXBeforeChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXBeforeChangeBrandDetailInline has change permission:::obj',False)
            return False



#品牌替换后明细的内嵌inline
class NXAfterChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=NXAfterChangeBrandDetailInlineForm
    model = NXAfterChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('NXAfterChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXAfterChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('NXAfterChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='NX' or request.user.groups.values()[1]['name'] =='NX':
            return True
        else:
            print('NXAfterChangeBrandDetailInline has change permission:::obj',False)
            return False


#品牌替换状态的内嵌inline
class NXChangeBrandStatusInline(nested_admin.NestedStackedInline):
    form= NXChangeBrandStatusInlineForm
    inlines=[NXBeforeChangeBrandDetailInline,NXAfterChangeBrandDetailInline]
    model =  NXChangeBrandStatus
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    fields=(('progress','completemonth'),
...
#-----------------------------------------------------------------
#套餐绑定明细的内嵌inline
class NXSetDetailInline(nested_admin.NestedTabularInline):
    form=NXSetDetailInlineForm
    model = NXSetDetail
    fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_estmonthlygpgrowth',) #'costfeepercent','marketpricefeepercent', 'newcostfeepercent') #'field_lissettleprice', 'field_recentgp',
...
#套餐绑定状态的内嵌inline
class NXSetStatusInline(nested_admin.NestedStackedInline):
    form=NXSetStatusInlineForm
    inlines=[NXSetDetailInline]
    model = NXSetStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
#----------------------------------------------------------------
#作战计划计算表
class NXCalculateInline(nested_admin.NestedStackedInline):
    model = NXCalculate
    # fk_name = "overallid"
    extra = 0
...
#----------------------------------------------------------------
#该科室该项目大类的相关产品明细'
class NXMenuforinlineInline(nested_admin.NestedTabularInline):
    model = NXMenuforinline
    form=NXMenuforinlineInlineForm
    # fk_name = "overallid"
    extra = 0
    # readonly_fields = ('estnewgpgrowth','realnewgpgrowth','newgpgrowthpercent',
    #                     'estnegogpgrowth','realnegogpgrowth','negogpgrowthpercent',
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!``````````````````````````````````````
#作战计划总表
@admin.register(NXOverall)
class NXOverallAdmin(nested_admin.NestedModelAdmin):
    form = NXOverallForm
    inlines=[NXMenuforinlineInline,NXNewProjectStatusInline,NXNegotiationStatusInline,NXChangeChannelStatusInline,NXChangeBrandStatusInline,NXSetStatusInline,NXCalculateInline]
    exclude = ('id','createtime','updatetime','is_active','operator')
    search_fields=['department','semidepartment','project','supplier','nxmenuforinline__product']
    ...
    #把项目的id放入redis，方便下面的NXMENU来获取对应id的details
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        if not existed_redis_data:
            ...
            print(cache.set(username,existed_redis_data,None),'NXOverallAdmin(nested_admin.NestedModelAdmin)')
    ...
    def delete_model(self, request, obj):
        ...
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or obj.salesman==request.user:             
            obj.is_active = False 
            obj.operator=request.user   
            if NXNewProjectStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.nxnewprojectstatus_set.all().update(is_active=False)
            if  NXNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if NXNegotiationStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.nxnegotiationstatus_set.all().update(is_active=False)
            if  NXNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if NXChangeChannelStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.nxchangechannelstatus_set.all().update(is_active=False)
            if  NXChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if NXChangeBrandStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.nxchangebrandstatus_set.all().update(is_active=False)
            if  NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)
            if  NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if NXSetStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.nxsetstatus_set.all().update(is_active=False)
            if  NXSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                NXSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            # if NXMenu.objects.filter(overallid__id=obj.id,is_active=True):
            #     obj.NXmenu_set.all().update(is_active=False)
   
            if  NXCalculate.objects.filter(overallid__id=obj.id,is_active=True):   
                obj.nxcalculate.is_active=False
                obj.nxcalculate.save()
    ...
    def delete_queryset(self,request, queryset):        
            ...
            for delete_obj in queryset:     
                ...
                if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or delete_obj.salesman==request.user:     
                    delete_obj.is_active=False
                    delete_obj.operator=request.user
                    if NXNewProjectStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.nxnewprojectstatus_set.all().update(is_active=False)
                    if  NXNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if NXNegotiationStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.nxnegotiationstatus_set.all().update(is_active=False)
                    if  NXNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  NXChangeChannelStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.nxchangechannelstatus_set.all().update(is_active=False)
                    if  NXChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if NXChangeBrandStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.nxchangebrandstatus_set.all().update(is_active=False)
                    if  NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    if  NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    
                    if NXSetStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.nxsetstatus_set.all().update(is_active=False)
                    if  NXSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        NXSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  NXCalculate.objects.filter(overallid__id=delete_obj.id,is_active=True):   
                        delete_obj.nxcalculate.is_active=False
                        delete_obj.nxcalculate.save()
                    delete_obj.save()
    ...
    def save_related(self, request, form, formsets, change): 
        ...
        for eachformset in formsets: #循环每一个增量来源及明细,删除多填的信息
            ...
            if eachformset.model==NXNewProjectStatus:
                # print('eachformset-------NXNewProjectStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=NXNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=NXNewProjectDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
            ...
            if eachformset.model==NXNegotiationStatus:
                # print('eachformset------NXNegotiationStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.form)
                statusobjs=NXNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=NXNegotiationDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()
                if statusobjs:
                    print('statusobjs[0]',statusobjs[0])
            ...
            if eachformset.model==NXChangeChannelStatus:
                # print('eachformset-------NXChangeChannelStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=NXChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=NXChangeChannelDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()  
                if statusobjs:   
                    whygrowth+='渠道变更,'

            if eachformset.model==NXChangeBrandStatus:
                # print('eachformset-------NXChangeBrandStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=NXChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=NXBeforeChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        detailobjs2=NXAfterChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs2.update(is_active=False)
                        statusobjs[i].delete() 
                if statusobjs: 
                    whygrowth+='品牌替换,'

            if eachformset.model==NXSetStatus:
                # print('eachformset-------NXSetStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=NXSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=NXSetDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)       
                        statusobjs[i].delete()  
                if statusobjs:
                    whygrowth+='套餐绑定,'
        ...
        for eachdetail in NXNewProjectDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
        ...
        if  NXNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            newprojectobject= NXNewProjectStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in NXNegotiationDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
        ...
        if NXNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('negotiationobject',NXNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            negotiationobject= NXNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in NXChangeChannelDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code)            
            eachdetail.originalbrand=eachdetail.productid.brand
            eachdetail.spec=eachdetail.productid.spec
        ...
        if NXChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changechannelobject',NXChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changechannelobject= NXChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            # print('eachdetail',eachdetail)
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code) 
            eachdetail.originalsupplier=eachdetail.productid.supplier
        ...
        for eachdetail in NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
        ...
        if NXChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changebrandobject',NXChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changebrandobject= NXChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in NXSetDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
            #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
            eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
        ...
        if  NXSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            setobject= NXSetStatus.objects.get(overallid__id=form.instance.id,is_active=True)
      ...
      #CALCULATE 用销售填报的月毛利额增量预估来填：
        if NXCalculate.objects.filter(overallid__id=form.instance.id,is_active=True):
            # print('原本有calculate：',NXCalculate.objects.get(overallid__id=form.instance.id,is_active=True))
            a=NXCalculate.objects.get(overallid__id=form.instance.id,is_active=True)
            a.estallgpgrowth=0
            a.estnewgpgrowth=0
            a.estnegogpgrowth=0    
            ...
            NXCalculate.objects.create(**NXCalculatedata).save()
        

        overallobject= NXOverall.objects.get(id=form.instance.id)
 ...
 #新增动作————统计按钮
    ...
    def calculate(self, request, queryset):
        for i in queryset:
            ...
            relation=[]
            whygrowth=''
            if NXNewProjectStatus.objects.filter(overallid__id=i.id,is_active=True):
                newprojectobject = NXNewProjectStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += newprojectobject.monthgpgrowth 
                overallthisyeargpgrowth += newprojectobject.thisyeargpgrowth
                progresses.append(newprojectobject.progress)
                completemonths.append(str(newprojectobject.completemonth) if newprojectobject.completemonth else '--' )
                ...
                for eachdata in NXNewProjectDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if NXNegotiationStatus.objects.filter(overallid__id=i.id,is_active=True):
                negotiationobject = NXNegotiationStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += negotiationobject.monthgpgrowth 
                overallthisyeargpgrowth += negotiationobject.thisyeargpgrowth
                progresses.append(negotiationobject.progress)
                completemonths.append(str(negotiationobject.completemonth) if negotiationobject.completemonth else '--' )
                ...
                for eachdata in NXNegotiationDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if NXChangeChannelStatus.objects.filter(overallid__id=i.id,is_active=True):
                changechannelobject = NXChangeChannelStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changechannelobject.monthgpgrowth 
                overallthisyeargpgrowth += changechannelobject.thisyeargpgrowth
                progresses.append(changechannelobject.progress)
                completemonths.append(str(changechannelobject.completemonth) if changechannelobject.completemonth else '--' )
                ...
                for eachdata in NXChangeChannelDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if NXChangeBrandStatus.objects.filter(overallid__id=i.id,is_active=True):
                changebrandobject = NXChangeBrandStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changebrandobject.monthgpgrowth 
                overallthisyeargpgrowth += changebrandobject.thisyeargpgrowth
                progresses.append(changebrandobject.progress)
                completemonths.append(str(changebrandobject.completemonth) if changebrandobject.completemonth else '--' )
                ...
                for eachdata in NXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
                    beforechangebrandmonthgp+=eachdata.monthgp
                for eachdata in NXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if NXSetStatus.objects.filter(overallid__id=i.id,is_active=True):
                setobject = NXSetStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += setobject.monthgpgrowth 
                overallthisyeargpgrowth += setobject.thisyeargpgrowth
                progresses.append(setobject.progress)
                completemonths.append(str(setobject.completemonth) if setobject.completemonth else '--' )
                ...
                whygrowth+='套餐绑定,'
                setestgpgrowth=0      
                for eachdata in NXSetDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#新开项目状态
@admin.register(NXNewProjectStatus)
class NXNewProjectStatusAdmin(nested_admin.NestedModelAdmin):
...
#新开项目明细
@admin.register(NXNewProjectDetail)
class NXNewProjectDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
...
#供应商重新谈判状态
@admin.register(NXNegotiationStatus)
class NXNegotiationStatusAdmin(nested_admin.NestedModelAdmin):
...
#供应商重新谈判明细
@admin.register(NXNegotiationDetail)
class NXNegotiationDetailAdmin(nested_admin.NestedModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'productid': 
            kwargs["queryset"] = NXMenu.objects.filter(is_active=True) 
        return super().formfield_for_foreignkey(db_field, request, **kwargs)
...
#渠道变更明细
@admin.register(NXChangeChannelDetail)
class NXChangeChannelDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换前明细
@admin.register(NXBeforeChangeBrandDetail)
class NXBeforeChangeBrandAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换后明细
@admin.register(NXAfterChangeBrandDetail)
class NXAfterChangeBrandDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
...
#套餐绑定明细
@admin.register(NXSetDetail)
class NXSetDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
    list_display = ('progressid__overallid__semidepartment','progressid__overallid__project','progressid__progress','originalsupplier','originalbrand',#newsupplier，beforeorafterbrandchange
                    'code','product','spec', 
...
@admin.register(NXMenu)  
class NXMenuAdmin(GlobalAdmin):   
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if 'autocomplete' in request.path:
            ...
            existed_redis_data = cache.get(username)
            if existed_redis_data:
                print(existed_redis_data,'class NXMenuAdmin(GlobalAdmin): ~~~~~~~~~~~~~~~')
...
@admin.register(NXOverallDELETE)
class NXOverallDELETEAdmin(admin.ModelAdmin):
    exclude = ('id','createtime','updatetime','is_active','operator')
 ...
 #只显示未被假删除的项目
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=False,company_id=10)
    ...
    def restore(self, request, queryset):
        ...
        print('我在restore')      
        for i in queryset:
            # print(i.nxnewprojectstatusdelete_set.all())
            i.nxnewprojectstatusdelete_set.all().update(is_active=True)
            for j in i.nxnewprojectstatusdelete_set.all():
                if hasattr(j, 'nxnewprojectdetaildelete_set'):
                    j.nxnewprojectdetaildelete_set.all().update(is_active=True)

            i.nxnegotiationstatusdelete_set.all().update(is_active=True)
            for j in i.nxnegotiationstatusdelete_set.all():
                # print('~~~~~!',j)
                # print('all',j.nxnegotiationdetaildelete_set.all())
                if hasattr(j, 'nxnegotiationdetaildelete_set'):
                    # print("~~~~~hasattrnxnegotiationdetaildelete", j.nxnegotiationdetaildelete_set.all())
                    j.nxnegotiationdetaildelete_set.all().update(is_active=True)

            i.nxchangechannelstatusdelete_set.all().update(is_active=True)
            for j in i.nxchangechannelstatusdelete_set.all():
                # print('~~~~~~',j)
                if hasattr(j, 'nxchangechanneldetaildelete_set'):
                    # print("~~~~~", j.nxchangechanneldetaildelete_set.all())
                    j.nxchangechanneldetaildelete_set.all().update(is_active=True)

            i.nxchangebrandstatusdelete_set.all().update(is_active=True)
            
            for j in i.nxchangebrandstatusdelete_set.all():
                if hasattr(j, 'nxchangebranddetaildelete_set'):
                    j.nxchangebranddetaildelete_set.all().update(is_active=True)

            i.nxsetstatusdelete_set.all().update(is_active=True)
            for j in i.nxsetstatusdelete_set.all():
                if hasattr(j, 'nxsetdetaildelete_set'):
                    j.nxsetdetaildelete_set.all().update(is_active=True)

            if hasattr(i, 'nxcalculatedelete'):
                i.nxcalculatedelete.is_active=True
                i.nxcalculatedelete.save()  
            print('恢复') 
