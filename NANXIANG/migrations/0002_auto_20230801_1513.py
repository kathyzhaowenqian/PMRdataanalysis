# Generated by Django 3.2 on 2023-08-01 07:13

import NANXIANG.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='NXAfterChangeBrandDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXBeforeChangeBrandDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXChangeBrandStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXChangeChannelDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXChangeChannelStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXNegotiationDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='NXNegotiationStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('company', models.ForeignKey(db_column='company', default=NANXIANG.models.get_compmany_default_value, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.company', verbose_name='公司')),
                ('operator', models.ForeignKey(db_column='operator', on_delete=django.db.models.deletion.CASCADE, related_name='operatorNXoverall', to='NANXIANG.nxuserinfo', verbose_name='最后操作人')),
                ('salesman', models.ForeignKey(db_column='salesman', default=7, on_delete=django.db.models.deletion.CASCADE, related_name='salesmanNXoverall', to='NANXIANG.nxuserinfo', verbose_name='负责人')),
            ],
            options={
                'verbose_name_plural': '南翔作战计划',
                'db_table': 'marketing_research_v2"."NXPlanOverall',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxoverall', verbose_name='作战计划')),
            ],
            options={
                'verbose_name_plural': '南翔套餐绑定状态',
                'db_table': 'marketing_research_v2"."NXSetStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxsetstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '南翔套餐绑定明细',
                'db_table': 'marketing_research_v2"."NXSetDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxnewprojectstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '南翔新开项目明细',
                'db_table': 'marketing_research_v2"."NXNewProjectDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxmenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxnegotiationstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '南翔供应商重新谈判明细',
                'db_table': 'marketing_research_v2"."NXNegotiationDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', default=1, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxoverall', verbose_name='主表id')),
            ],
            options={
                'verbose_name_plural': '南翔大菜单作展示',
                'db_table': 'marketing_research_v2"."NXMenuforinline',
        ...
        migrations.AddField(
            model_name='nxmenu',
            name='overallid',
            field=models.ForeignKey(db_column='overallid', default=0, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxoverall', verbose_name='主表id'),
        ),
        migrations.CreateModel(
            name='NXChangeChannelStatus',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('whygrowth', models.CharField(default='渠道变更', max_length=255, verbose_name='增量来源')),
                ('progress', models.CharField(choices=[('待谈判', '待谈判'), ('已谈判等回复', '已谈判等回复'), ('新渠道价格已确认', '新渠道价格已确认')], default='待拜访', max_length=25, verbose_name='进度(必填)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxmenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxchangechannelstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '南翔渠道变更明细',
                'db_table': 'marketing_research_v2"."NXChangeChannelDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.OneToOneField(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxoverall', verbose_name='作战计划')),
            ],
            options={
                'verbose_name_plural': '南翔作战计划计算表',
                'db_table': 'marketing_research_v2"."NXCalculate',
        ...
        migrations.CreateModel(
            name='NXBeforeChangeBrandDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('whygrowth', models.CharField(default='品牌替换前', max_length=255, verbose_name='增量来源')),
                ('originalsupplier', models.CharField(blank=True, help_text='请按系统中供应商名称填报', max_length=255, null=True, verbose_name='供应商')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxmenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='NANXIANG.nxchangebrandstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '南翔品牌替换前明细',
                'db_table': 'marketing_research_v2"."NXBeforeChangeBrandDetail',
