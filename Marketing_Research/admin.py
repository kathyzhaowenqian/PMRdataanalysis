...
class PMRResearchListAdmin(GlobalAdmin):
    ...
    list_filter = [ProjectFilter,'hospital__district','hospital__hospitalclass',SalesmanFilter,SalesmanFilter2,'detailcalculate__newold',IfTargetCustomerFilter,IfActualSalesFilter,IfSalesChannelFilter,IfSupportFilter]
...
#每季度实际完成额
    ...
    actualsales_24_q1.admin_order_field = '-salestarget__q1actualsales'
    ...
    actualsales_24_q2.admin_order_field = '-salestarget__q2actualsales'
    ...
    actualsales_24_q3.admin_order_field = '-salestarget__q3actualsales'
    ...
    actualsales_24_q4.admin_order_field = '-salestarget__q4actualsales'
