...
from django.contrib import admin
from SIWUWU.models import *
from SIWUWU.models_delete import *
...
@admin.register(SWWUserInfo)  
class SWWUserAdmin(UserAdmin):  
...
@admin.register(SWWSWWList)
class SWWSPDListAdmin(GlobalAdmin):
    ...
    ordering = ('id',)
    view_group_list = ['boss','SWW','allviewonly','JConlyview']

    # 新增或修改数据时，设置外键可选值，
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'company': 
            kwargs["queryset"] = Company.objects.filter(is_active=True,id=8) 
        if db_field.name == 'salesman': 
            kwargs["queryset"] = UserInfo.objects.filter(Q(is_active=True) & Q(username__in= ['zyj']))
...
# ------delete_model内层的红色删除键------------------------------
    ...
    def get_queryset(self, request):
        ...
        if request.user.is_superuser :
            return qs.filter(is_active=True,company_id=8)
...
# #----------FORM-------LIST--------
# class SWWOverallForm(forms.ModelForm):
...
# class SWWNewProjectDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWNewProjectDetail
#             exclude = ['id']
#             widgets = {
...
# class SWWNegotiationDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         # print('aaaaaaaaaaaaaaaaaaaaaaaaaaa')
#         self.fields['productid'].queryset =  SWWMenu.objects.filter(is_active=True)

#     class Meta: 
#             model = SWWNegotiationDetail
#             exclude = ['id']
#             widgets = {
...
# class SWWChangeChannelDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         self.fields['productid'].queryset =  SWWMenu.objects.filter(is_active=True)

#     class Meta: 
#             model = SWWChangeChannelDetail
#             exclude = ['id']
#             widgets = {
#                 'productid': AutocompleteSelect(
#                     model._meta.get_field('productid'),
...
# class SWWBeforeChangeBrandDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         self.fields['productid'].queryset =  SWWMenu.objects.filter(is_active=True)

#     class Meta: 
#             model = SWWBeforeChangeBrandDetail
#             exclude = ['id']
#             widgets = {
#                 'productid': AutocompleteSelect(
#                     model._meta.get_field('productid'),
...
# class SWWAfterChangeBrandDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWAfterChangeBrandDetail
#             exclude = ['id']
#             widgets = {
#                 'originalsupplier': forms.TextInput(attrs={'size':'10'}),
#                 'originalbrand': forms.TextInput(attrs={'size':'5'}),
...
# class SWWSetDetailInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
...
# class SWWNewProjectStatusInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWNewProjectStatus
#             exclude = ['id']
#             widgets = {
...
# class SWWNegotiationStatusInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWNegotiationStatus
#             exclude = ['id']
#             widgets = {
...
# class SWWChangeChannelStatusInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWChangeChannelStatus
#             exclude = ['id']
#             widgets = {
...
# class SWWChangeBrandStatusInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
 
#     class Meta: 
#             model = SWWChangeBrandStatus
#             exclude = ['id']
#             widgets = {
...
# class SWWSetStatusInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
...
# class SWWMenuforinlineInlineForm(forms.ModelForm):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
...
# #---------------------------------------------------------------
# #新开项目明细的内嵌inline
# class SWWNewProjectDetailInline(nested_admin.NestedTabularInline):
#     form=SWWNewProjectDetailInlineForm
#     model = SWWNewProjectDetail
#     fk_name = "progressid"
#     extra = 0
...
#         print('SWWNewProjectDetailInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNewProjectDetailInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWNewProjectDetailInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNewProjectDetailInline has change permission:::obj',False)
#             return False
        
# #新开项目状态的内嵌inline
# class SWWNewProjectStatusInline(nested_admin.NestedStackedInline):
#     form=SWWNewProjectStatusInlineForm
#     inlines=[SWWNewProjectDetailInline]
#     model = SWWNewProjectStatus
#     # fk_name = "overallid"
#     extra = 0
...
#     def has_add_permission(self,request,obj):
#         print('SWWNewProjectStatusInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNewProjectStatusInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWNewProjectStatusInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNewProjectStatusInline has change permission:::obj',False)
#             return False

# #----------------------------------------------------------------
# #供应商重新谈判明细的内嵌inline
# class SWWNegotiationDetailInline(nested_admin.NestedTabularInline):
#     form=SWWNegotiationDetailInlineForm
#     model = SWWNegotiationDetail
#     extra = 0
...
#         # return qs.filter((Q(is_active=True)&Q(researchlist__salesman1=request.user))|(Q(is_active=True)&Q(researchlist__salesman2=request.user)))
#     def has_add_permission(self,request,obj):
#         print('SWWNegotiationDetailInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNegotiationDetailInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWNegotiationDetailInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNegotiationDetailInline has change permission:::obj',False)
#             return False

# #供应商重新谈判状态的内嵌inline
# class SWWNegotiationStatusInline(nested_admin.NestedStackedInline):
#     form=SWWNegotiationStatusInlineForm
#     inlines=[SWWNegotiationDetailInline]
#     model = SWWNegotiationStatus
#     fk_name = "overallid"
#     extra = 0
#     readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
#     def has_add_permission(self,request,obj):
#         print('SWWNegotiationStatusInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNegotiationStatusInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWNegotiationStatusInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWNegotiationStatusInline has change permission:::obj',False)
#             return False
# #----------------------------------------------------------------
# #渠道变更明细的内嵌inline
# class SWWChangeChannelDetailInline(nested_admin.NestedTabularInline):
#     form=SWWChangeChannelDetailInlineForm
#     model = SWWChangeChannelDetail
#     # fk_name = "progressid"
#     extra = 0
#     readonly_fields= ('field_recentsales','field_recentcost','field_recentgp','field_recentgpofsupplier','field_estmonthlygpgrowth')#'field_lissettleprice') 
...
#     def has_add_permission(self,request,obj):
#         print('SWWChangeChannelDetailInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWChangeChannelDetailInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWChangeChannelDetailInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWChangeChannelDetailInline has change permission:::obj',False)
#             return False

# #渠道变更状态的内嵌inline
# class SWWChangeChannelStatusInline(nested_admin.NestedStackedInline):
#     form=SWWChangeChannelStatusInlineForm
#     inlines=[SWWChangeChannelDetailInline]
#     model = SWWChangeChannelStatus
#     # fk_name = "overallid"
#     extra = 0
#     readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
#     def has_add_permission(self,request,obj):
#         print('SWWChangeChannelStatusInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWChangeChannelStatusInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWChangeChannelStatusInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWChangeChannelStatusInline has change permission:::obj',False)
#             return False
# #-----------------------------------------------------------------
# #品牌替换前明细的内嵌inline
# class SWWBeforeChangeBrandDetailInline(nested_admin.NestedTabularInline):
#     form=SWWBeforeChangeBrandDetailInlineForm
#     model = SWWBeforeChangeBrandDetail
#     fk_name = "progressid"
#     extra = 0
...
#     def has_add_permission(self,request,obj):
#         print('SWWBeforeChangeBrandDetailInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWBeforeChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWBeforeChangeBrandDetailInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWBeforeChangeBrandDetailInline has change permission:::obj',False)
#             return False



# #品牌替换后明细的内嵌inline
# class SWWAfterChangeBrandDetailInline(nested_admin.NestedTabularInline):
#     form=SWWAfterChangeBrandDetailInlineForm
#     model = SWWAfterChangeBrandDetail
#     fk_name = "progressid"
#     extra = 0
...
#     def has_add_permission(self,request,obj):
#         print('SWWAfterChangeBrandDetailInline has add permission:::obj',obj,request.user) 
#         if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWAfterChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
#             return False

#     def has_change_permission(self,request, obj=None):
#         print('SWWAfterChangeBrandDetailInline has change permission:: obj',obj)
#         if obj==None:
#             return True            
#         elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='SWW':
#             return True
#         else:
#             print('SWWAfterChangeBrandDetailInline has change permission:::obj',False)
#             return False


# #品牌替换状态的内嵌inline
# class SWWChangeBrandStatusInline(nested_admin.NestedStackedInline):
#     form= SWWChangeBrandStatusInlineForm
#     inlines=[SWWBeforeChangeBrandDetailInline,SWWAfterChangeBrandDetailInline]
#     model =  SWWChangeBrandStatus
#     extra = 0
#     readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
#     fields=(('progress','completemonth'),
...
# #-----------------------------------------------------------------
# #套餐绑定明细的内嵌inline
# class SWWSetDetailInline(nested_admin.NestedTabularInline):
#     form=SWWSetDetailInlineForm
#     model = SWWSetDetail
#     fk_name = "progressid"
#     extra = 0
#     readonly_fields= ('field_estmonthlygpgrowth',) #'costfeepercent','marketpricefeepercent', 'newcostfeepercent') #'field_lissettleprice', 'field_recentgp',
...
# #套餐绑定状态的内嵌inline
# class SWWSetStatusInline(nested_admin.NestedStackedInline):
#     form=SWWSetStatusInlineForm
#     inlines=[SWWSetDetailInline]
#     model = SWWSetStatus
#     # fk_name = "overallid"
#     extra = 0
#     readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
# #----------------------------------------------------------------
# #作战计划计算表
# class SWWCalculateInline(nested_admin.NestedStackedInline):
#     model = SWWCalculate
#     # fk_name = "overallid"
#     extra = 0
...
# #----------------------------------------------------------------
# #该科室该项目大类的相关产品明细'
# class SWWMenuforinlineInline(nested_admin.NestedTabularInline):
#     model = SWWMenuforinline
#     form=SWWMenuforinlineInlineForm
#     # fk_name = "overallid"
#     extra = 0
#     # readonly_fields = ('estnewgpgrowth','realnewgpgrowth','newgpgrowthpercent',
#     #                     'estnegogpgrowth','realnegogpgrowth','negogpgrowthpercent',
...
# #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!``````````````````````````````````````
# #作战计划总表
# @admin.register(SWWOverall)
# class SWWOverallAdmin(nested_admin.NestedModelAdmin):
#     form = SWWOverallForm
#     inlines=[SWWMenuforinlineInline,SWWNewProjectStatusInline,SWWNegotiationStatusInline,SWWChangeChannelStatusInline,SWWChangeBrandStatusInline,SWWSetStatusInline,SWWCalculateInline]
#     exclude = ('id','createtime','updatetime','is_active','operator')
#     search_fields=['department','semidepartment','project','supplier','SWWmenuforinline__product']
...
#     #把项目的id放入redis，方便下面的SWWMENU来获取对应id的details
...
#             print(cache.set(username,existed_redis_data,None),'SWWOverallAdmin(nested_admin.NestedModelAdmin)')
...
#             obj.is_active = False 
#             obj.operator=request.user   
#             if SWWNewProjectStatus.objects.filter(overallid__id=obj.id,is_active=True):
#                 obj.swwnewprojectstatus_set.all().update(is_active=False)
#             if  SWWNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

#             if SWWNegotiationStatus.objects.filter(overallid__id=obj.id,is_active=True):
#                 obj.swwnegotiationstatus_set.all().update(is_active=False)
#             if  SWWNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

#             if SWWChangeChannelStatus.objects.filter(overallid__id=obj.id,is_active=True):
#                 obj.swwchangechannelstatus_set.all().update(is_active=False)
#             if  SWWChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

#             if SWWChangeBrandStatus.objects.filter(overallid__id=obj.id,is_active=True):
#                 obj.swwchangebrandstatus_set.all().update(is_active=False)
#             if  SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)
#             if  SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

#             if SWWSetStatus.objects.filter(overallid__id=obj.id,is_active=True):
#                 obj.swwsetstatus_set.all().update(is_active=False)
#             if  SWWSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
#                 SWWSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

#             # if SWWMenu.objects.filter(overallid__id=obj.id,is_active=True):
#             #     obj.SWWmenu_set.all().update(is_active=False)
   
#             if  SWWCalculate.objects.filter(overallid__id=obj.id,is_active=True):   
#                 obj.swwcalculate.is_active=False
#                 obj.swwcalculate.save()
...
#                     delete_obj.is_active=False
#                     delete_obj.operator=request.user
#                     if SWWNewProjectStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
#                         delete_obj.swwnewprojectstatus_set.all().update(is_active=False)
#                     if  SWWNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

#                     if SWWNegotiationStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
#                         delete_obj.swwnegotiationstatus_set.all().update(is_active=False)
#                     if  SWWNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

#                     if  SWWChangeChannelStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
#                         delete_obj.swwchangechannelstatus_set.all().update(is_active=False)
#                     if  SWWChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

#                     if SWWChangeBrandStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
#                         delete_obj.swwchangebrandstatus_set.all().update(is_active=False)
#                     if  SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
#                     if  SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    
#                     if SWWSetStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
#                         delete_obj.swwsetstatus_set.all().update(is_active=False)
#                     if  SWWSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
#                         SWWSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

#                     if  SWWCalculate.objects.filter(overallid__id=delete_obj.id,is_active=True):   
#                         delete_obj.swwcalculate.is_active=False
#                         delete_obj.swwcalculate.save()
#                     delete_obj.save()
...
#             if eachformset.model==SWWNewProjectStatus:
#                 # print('eachformset-------SWWNewProjectStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
#                 # print('eachformset.forms',eachformset.forms)
#                 statusobjs=SWWNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
#                 if len(statusobjs)>1:
#                     for i in range(1,len(statusobjs)):
#                         detailobjs=SWWNewProjectDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
...
#             if eachformset.model==SWWNegotiationStatus:
#                 # print('eachformset------SWWNegotiationStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
#                 # print('eachformset.forms',eachformset.form)
#                 statusobjs=SWWNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
#                 if len(statusobjs)>1:
#                     for i in range(1,len(statusobjs)):
#                         detailobjs=SWWNegotiationDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
#                         detailobjs.update(is_active=False)
#                         statusobjs[i].delete()
#                 if statusobjs:
#                     print('statusobjs[0]',statusobjs[0])
...
#             if eachformset.model==SWWChangeChannelStatus:
#                 # print('eachformset-------SWWChangeChannelStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
#                 # print('eachformset.forms',eachformset.forms)
#                 statusobjs=SWWChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
#                 if len(statusobjs)>1:
#                     for i in range(1,len(statusobjs)):
#                         detailobjs=SWWChangeChannelDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
#                         detailobjs.update(is_active=False)
#                         statusobjs[i].delete()  
#                 if statusobjs:   
#                     whygrowth+='渠道变更,'

#             if eachformset.model==SWWChangeBrandStatus:
#                 # print('eachformset-------SWWChangeBrandStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
#                 # print('eachformset.forms',eachformset.forms)
#                 statusobjs=SWWChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
#                 if len(statusobjs)>1:
#                     for i in range(1,len(statusobjs)):
#                         detailobjs=SWWBeforeChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
#                         detailobjs.update(is_active=False)
#                         detailobjs2=SWWAfterChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
#                         detailobjs2.update(is_active=False)
#                         statusobjs[i].delete() 
#                 if statusobjs: 
#                     whygrowth+='品牌替换,'

#             if eachformset.model==SWWSetStatus:
#                 # print('eachformset-------SWWSetStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
#                 # print('eachformset.forms',eachformset.forms)
#                 statusobjs=SWWSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
#                 if len(statusobjs)>1:
#                     for i in range(1,len(statusobjs)):
#                         detailobjs=SWWSetDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
#                         detailobjs.update(is_active=False)       
#                         statusobjs[i].delete()  
#                 if statusobjs:
#                     whygrowth+='套餐绑定,'
...
#         for eachdetail in SWWNewProjectDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
...
#         if  SWWNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
#             newprojectobject= SWWNewProjectStatus.objects.get(overallid__id=form.instance.id,is_active=True)
...
#         for eachdetail in SWWNegotiationDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
...
#         if SWWNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
#             print('negotiationobject',SWWNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True))
#             negotiationobject= SWWNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True)
...
#         for eachdetail in SWWChangeChannelDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
#             eachdetail.product=str(eachdetail.productid.product)
#             eachdetail.code=str(eachdetail.productid.code)            
#             eachdetail.originalbrand=eachdetail.productid.brand
#             eachdetail.spec=eachdetail.productid.spec
...
#         if SWWChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
#             print('changechannelobject',SWWChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True))
#             changechannelobject= SWWChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True)
...
#         for eachdetail in SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
#             # print('eachdetail',eachdetail)
#             eachdetail.product=str(eachdetail.productid.product)
#             eachdetail.code=str(eachdetail.productid.code) 
#             eachdetail.originalsupplier=eachdetail.productid.supplier
...
#         for eachdetail in SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
#             print('eachdetail',eachdetail)
...
#         if SWWChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
#             print('changebrandobject',SWWChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True))
#             changebrandobject= SWWChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True)
...
#         for eachdetail in SWWSetDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
#             print('eachdetail',eachdetail)
#             #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
#             eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
...
#         if  SWWSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
#             setobject= SWWSetStatus.objects.get(overallid__id=form.instance.id,is_active=True)
...
#         if SWWCalculate.objects.filter(overallid__id=form.instance.id,is_active=True):
#             # print('原本有calculate：',SWWCalculate.objects.get(overallid__id=form.instance.id,is_active=True))
#             a=SWWCalculate.objects.get(overallid__id=form.instance.id,is_active=True)
#             a.estallgpgrowth=0
#             a.estnewgpgrowth=0
#             a.estnegogpgrowth=0    
...
#                 'is_active':True,
#             }
#             SWWCalculate.objects.create(**SWWCalculatedata).save()
        

#         overallobject= SWWOverall.objects.get(id=form.instance.id)
...
#             relation=[]
#             whygrowth=''
#             if SWWNewProjectStatus.objects.filter(overallid__id=i.id,is_active=True):
#                 newprojectobject = SWWNewProjectStatus.objects.get(overallid__id=i.id,is_active=True)
#                 overallmonthgpgrowth += newprojectobject.monthgpgrowth 
#                 overallthisyeargpgrowth += newprojectobject.thisyeargpgrowth
#                 progresses.append(newprojectobject.progress)
#                 completemonths.append(str(newprojectobject.completemonth) if newprojectobject.completemonth else '--' )
...
#                 for eachdata in SWWNewProjectDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#             if SWWNegotiationStatus.objects.filter(overallid__id=i.id,is_active=True):
#                 negotiationobject = SWWNegotiationStatus.objects.get(overallid__id=i.id,is_active=True)
#                 overallmonthgpgrowth += negotiationobject.monthgpgrowth 
#                 overallthisyeargpgrowth += negotiationobject.thisyeargpgrowth
#                 progresses.append(negotiationobject.progress)
#                 completemonths.append(str(negotiationobject.completemonth) if negotiationobject.completemonth else '--' )
...
#                 for eachdata in SWWNegotiationDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#             if SWWChangeChannelStatus.objects.filter(overallid__id=i.id,is_active=True):
#                 changechannelobject = SWWChangeChannelStatus.objects.get(overallid__id=i.id,is_active=True)
#                 overallmonthgpgrowth += changechannelobject.monthgpgrowth 
#                 overallthisyeargpgrowth += changechannelobject.thisyeargpgrowth
#                 progresses.append(changechannelobject.progress)
#                 completemonths.append(str(changechannelobject.completemonth) if changechannelobject.completemonth else '--' )
...
#                 for eachdata in SWWChangeChannelDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#             if SWWChangeBrandStatus.objects.filter(overallid__id=i.id,is_active=True):
#                 changebrandobject = SWWChangeBrandStatus.objects.get(overallid__id=i.id,is_active=True)
#                 overallmonthgpgrowth += changebrandobject.monthgpgrowth 
#                 overallthisyeargpgrowth += changebrandobject.thisyeargpgrowth
#                 progresses.append(changebrandobject.progress)
#                 completemonths.append(str(changebrandobject.completemonth) if changebrandobject.completemonth else '--' )
...
#                 for eachdata in SWWBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
#                     beforechangebrandmonthgp+=eachdata.monthgp
#                 for eachdata in SWWAfterChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#             if SWWSetStatus.objects.filter(overallid__id=i.id,is_active=True):
#                 setobject = SWWSetStatus.objects.get(overallid__id=i.id,is_active=True)
#                 overallmonthgpgrowth += setobject.monthgpgrowth 
#                 overallthisyeargpgrowth += setobject.thisyeargpgrowth
#                 progresses.append(setobject.progress)
#                 completemonths.append(str(setobject.completemonth) if setobject.completemonth else '--' )
...
#                 whygrowth+='套餐绑定,'
#                 setestgpgrowth=0      
#                 for eachdata in SWWSetDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
# #新开项目状态
# @admin.register(SWWNewProjectStatus)
# class SWWNewProjectStatusAdmin(nested_admin.NestedModelAdmin):
...
# #新开项目明细
# @admin.register(SWWNewProjectDetail)
# class SWWNewProjectDetailAdmin(nested_admin.NestedModelAdmin):
#     exclude = ('id','createtime','updatetime')
...
# #供应商重新谈判状态
# @admin.register(SWWNegotiationStatus)
# class SWWNegotiationStatusAdmin(nested_admin.NestedModelAdmin):
...
# #供应商重新谈判明细
# @admin.register(SWWNegotiationDetail)
# class SWWNegotiationDetailAdmin(nested_admin.NestedModelAdmin):
...
#             kwargs["queryset"] = SWWMenu.objects.filter(is_active=True) 
#         return super().formfield_for_foreignkey(db_field, request, **kwargs)
...
# #渠道变更明细
# @admin.register(SWWChangeChannelDetail)
# class SWWChangeChannelDetailAdmin(nested_admin.NestedModelAdmin):
#     exclude = ('id','createtime','updatetime','skuhistory')
#     list_display_links=('progressid__overallid__project',)
...
# #品牌替换前明细
# @admin.register(SWWBeforeChangeBrandDetail)
# class SWWBeforeChangeBrandAdmin(nested_admin.NestedModelAdmin):
#     exclude = ('id','createtime','updatetime','skuhistory')
#     list_display_links=('progressid__overallid__project',)
...
# #品牌替换后明细
# @admin.register(SWWAfterChangeBrandDetail)
# class SWWAfterChangeBrandDetailAdmin(nested_admin.NestedModelAdmin):
#     exclude = ('id','createtime','updatetime')
#     list_display_links=('progressid__overallid__project',)
...
# #套餐绑定明细
# @admin.register(SWWSetDetail)
# class SWWSetDetailAdmin(nested_admin.NestedModelAdmin):
#     exclude = ('id','createtime','updatetime')
#     list_display_links=('progressid__overallid__project',)
#     list_display = ('progressid__overallid__semidepartment','progressid__overallid__project','progressid__progress','originalsupplier','originalbrand',#newsupplier，beforeorafterbrandchange
#                     'code','product','spec', 
...
# @admin.register(SWWMenu)  
# class SWWMenuAdmin(GlobalAdmin):   
...
#             existed_redis_data = cache.get(username)
#             if existed_redis_data:
#                 print(existed_redis_data,'class SWWMenuAdmin(GlobalAdmin): ~~~~~~~~~~~~~~~')
...
# @admin.register(SWWOverallDELETE)
# class SWWOverallDELETEAdmin(admin.ModelAdmin):
#     exclude = ('id','createtime','updatetime','is_active','operator')
...
#         qs = super().get_queryset(request)
#         if request.user.is_superuser :
#             return qs.filter(is_active=False,company_id=8)
...
#         print('我在restore')      
#         for i in queryset:
#             # print(i.SWWnewprojectstatusdelete_set.all())
#             i.swwnewprojectstatusdelete_set.all().update(is_active=True)
#             for j in i.swwnewprojectstatusdelete_set.all():
#                 if hasattr(j, 'swwnewprojectdetaildelete_set'):
#                     j.swwnewprojectdetaildelete_set.all().update(is_active=True)

#             i.swwnegotiationstatusdelete_set.all().update(is_active=True)
#             for j in i.swwnegotiationstatusdelete_set.all():
#                 # print('~~~~~!',j)
#                 # print('all',j.SWWnegotiationdetaildelete_set.all())
#                 if hasattr(j, 'swwnegotiationdetaildelete_set'):
#                     # print("~~~~~hasattrSWWnegotiationdetaildelete", j.SWWnegotiationdetaildelete_set.all())
#                     j.swwnegotiationdetaildelete_set.all().update(is_active=True)

#             i.swwchangechannelstatusdelete_set.all().update(is_active=True)
#             for j in i.swwchangechannelstatusdelete_set.all():
#                 # print('~~~~~~',j)
#                 if hasattr(j, 'swwchangechanneldetaildelete_set'):
#                     # print("~~~~~", j.SWWchangechanneldetaildelete_set.all())
#                     j.swwchangechanneldetaildelete_set.all().update(is_active=True)

#             i.swwchangebrandstatusdelete_set.all().update(is_active=True)
            
#             for j in i.swwchangebrandstatusdelete_set.all():
#                 if hasattr(j, 'swwchangebranddetaildelete_set'):
#                     j.swwchangebranddetaildelete_set.all().update(is_active=True)

#             i.swwsetstatusdelete_set.all().update(is_active=True)
#             for j in i.swwsetstatusdelete_set.all():
#                 if hasattr(j, 'swwsetdetaildelete_set'):
#                     j.swwsetdetaildelete_set.all().update(is_active=True)

#             if hasattr(i, 'swwcalculatedelete'):
#                 i.swwcalculatedelete.is_active=True
#                 i.swwcalculatedelete.save()  
#             print('恢复') 
