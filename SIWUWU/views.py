...
#             return render(request, 'SIWUWU/gantt2.html')
#         # else:
...
#         NewProjectStatus_queryset = SWWNewProjectStatus.objects.values('statushistory').filter(is_active=True)
#         NegotiationStatus_queryset = SWWNegotiationStatus.objects.values('statushistory').filter(is_active=True)
#         ChangeChannelStatus_queryset = SWWChangeChannelStatus.objects.values('statushistory').filter(is_active=True)
#         ChangeBrandStatus_queryset = SWWChangeBrandStatus.objects.values('statushistory').filter(is_active=True)
#         SetStatus_queryset = SWWSetStatus.objects.values('statushistory').filter(is_active=True)
