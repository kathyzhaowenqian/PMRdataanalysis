# Generated by Django 3.2 on 2023-03-30 05:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salesmode', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('我司业务:', ('代理', '代理')), ('非我司业务:', (('竞品', '竞品'), ('空白市场', '空白市场')))], max_length=25, null=True, verbose_name='销售模式')),
                ('testspermonth', models.PositiveIntegerField(default=0, verbose_name='总体月测试数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_goldesite', models.BooleanField(choices=[(True, '是'), (False, '否')], default=False, verbose_name='是否国赛')),
                ...
                ('competitionrelation', models.ForeignKey(db_column='competitionrelation', null=True, on_delete=django.db.models.deletion.CASCADE, to='Marketing_Research_ZS.competitionrelation', verbose_name='竞品关系点')),
                ('detailedproject', models.ForeignKey(db_column='detailedproject', help_text='例如:若本页项目为流式,则项目细分为流式项目下的具体细分', null=True, on_delete=django.db.models.deletion.CASCADE, to='Marketing_Research_ZS.gsmrprojectdetail', verbose_name='项目细分(注意根据本页主项目填报)')),
                ('researchlist', models.ForeignKey(db_column='researchlist', on_delete=django.db.models.deletion.CASCADE, to='Marketing_Research_ZS.gsmrresearchlist', verbose_name='调研列表')),
            ],
            options={
