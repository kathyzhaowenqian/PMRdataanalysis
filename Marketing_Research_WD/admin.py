...
class IfTargetCustomerFilter(SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if self.value() == '2':
            return queryset.filter(Q(salestarget2__q2target__gt= 0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
        if self.value() == '3':
            return queryset.filter(Q(salestarget2__q3target__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
        if self.value() == '4':
            return queryset.filter(Q(salestarget2__q4target__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
...
class IfActualSalesFilter(SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if self.value() == '2': #Q1已开票
            return queryset.filter(Q(salestarget2__q1actualsales__gt= 0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
        if self.value() == '3':#Q2已开票
            return queryset.filter(Q(salestarget2__q2actualsales__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
        if self.value() == '4':#Q3已开票
            return queryset.filter(Q(salestarget2__q3actualsales__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
        if self.value() == '5':#Q4已开票
            return queryset.filter(Q(salestarget2__q4actualsales__gt=0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023') )
...
class PMRResearchListAdmin(GlobalAdmin):
    ...
    list_filter = [ProjectFilter,'hospital__district','hospital__hospitalclass',SalesmanFilter,SalesmanFilter2,'detailcalculate2__newold',IfTargetCustomerFilter,IfActualSalesFilter,IfSalesChannelFilter,CustomerProjectTypeFilter]
