...
class ProjectFilter(SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        ...
        projects = Project.objects.filter(company_id=3,is_active=True)
...
class IfTargetCustomerFilter(SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        # pdb.set_trace()
        if self.value() == '1':
            return queryset.filter((Q(salestarget2__q1target__gt= 0)|Q(salestarget2__q2target__gt =0)|Q(salestarget2__q3target__gt =0)|Q(salestarget2__q4target__gt=0)) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '2':
            return queryset.filter(Q(salestarget2__q2target__gt= 0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '3':
            return queryset.filter(Q(salestarget2__q3target__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '4':
            return queryset.filter(Q(salestarget2__q4target__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
  
        elif self.value() == '5':
            return queryset.filter(Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') & Q(salestarget2__q1target = 0)& Q(salestarget2__q2target =0) & Q(salestarget2__q3target =0)& Q(salestarget2__q4target=0))
...
class CustomerProjectTypeFilter(SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if self.value() == '1':#老客户(去年已开票)
            ...
            return queryset.filter(((Q(salestarget2__q1actualsales= 0)&Q(salestarget2__q2actualsales =0)&Q(salestarget2__q3actualsales =0)&Q(salestarget2__q4actualsales=0)) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2023')))
...
class IfActualSalesFilter(SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if self.value() == '1':#24年已开票
            return queryset.filter((Q(salestarget2__q1actualsales__gt= 0)|Q(salestarget2__q2actualsales__gt =0)|Q(salestarget2__q3actualsales__gt =0)|Q(salestarget2__q4actualsales__gt=0)) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '2': #Q1已开票
            return queryset.filter(Q(salestarget2__q1actualsales__gt= 0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '3':#Q2已开票
            return queryset.filter(Q(salestarget2__q1actualsales =0)&Q(salestarget2__q2actualsales__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '4':#Q3已开票
            return queryset.filter(Q(salestarget2__q1actualsales =0)&Q(salestarget2__q2actualsales =0)&Q(salestarget2__q3actualsales__gt =0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        if self.value() == '5':#Q4已开票
            return queryset.filter(Q(salestarget2__q1actualsales =0)&Q(salestarget2__q2actualsales =0)&Q(salestarget2__q3actualsales =0)&Q(salestarget2__q4actualsales__gt=0) & Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') )
        elif self.value() == '6':#24年未开票
            return queryset.filter(Q(salestarget2__is_active=True) & Q(salestarget2__year='2024') & Q(salestarget2__q1actualsales = 0)& Q(salestarget2__q2actualsales =0) & Q(salestarget2__q3actualsales =0)& Q(salestarget2__q4actualsales=0))
...
class SalesmanFilter(SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        ...
        salesmans = UserInfo2.objects.filter(Q(username__in= ['gsj','jll','hfj']))
...
class PMRResearchDetailInline(admin.TabularInline):
    ...
    WD_view_group_list = ['boss','pmrmanager','WDmanager','allviewonly']
...
class PMRResearchListAdmin(GlobalAdmin):
    ...
    list_filter = [ProjectFilter,'hospital__district','hospital__hospitalclass',SalesmanFilter,'detailcalculate2__newold',IfTargetCustomerFilter,CustomerProjectTypeFilter,IfActualSalesFilter,IfSalesChannelFilter,]
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        if db_field.name == 'salesman1': 
            ...
            kwargs["queryset"] = UserInfo.objects.filter(Q(is_active=True) & Q(username__in= ['gsj','jll','hfj']))
...
# ------delete_model内层的红色删除键------------------------------
    ...
    def save_related(self, request, form, formsets, change): 
        ...
        if form.cleaned_data.get('salesman1')==request.user or request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss': 
            ...
            samehospital=PMRResearchList2.objects.filter(Q(hospital_id=form.instance.hospital.id))
            ...
            samehospitalandsalesman=PMRResearchList2.objects.filter(Q(hospital_id=form.instance.hospital.id) & Q(salesman1_id=form.instance.salesman1.id))
   ...
   #这是通过saverelated点击保存时已经存入detailcalculate的数据
    ...
    detailcalculate_totalmachinenumber.admin_order_field = '-detailcalculate2__totalmachinenumber'
    ...
    detailcalculate_ownmachinenumberpercent.admin_order_field = '-detailcalculate2__ownmachinepercent'
...
#每季度目标额
    ...
    def salestarget_23_q1(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_23_q1.admin_order_field = '-salestarget2__q1target'
    ...
    def salestarget_23_q2(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_23_q2.admin_order_field = '-salestarget2__q2target'
    ...
    def salestarget_23_q3(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_23_q3.admin_order_field = '-salestarget2__q3target'
    ...
    def salestarget_23_q4(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)    
    salestarget_23_q4.admin_order_field = '-salestarget2__q4target'
    ...
    def salestarget_24_q1(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_24_q1.admin_order_field = '-salestarget2__q1target'
    ...
    def salestarget_24_q2(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_24_q2.admin_order_field = '-salestarget2__q2target'
    ...
    def salestarget_24_q3(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_24_q3.admin_order_field = '-salestarget2__q3target'
    ...
    def salestarget_24_q4(self, obj):
        ...
        return format_html(
                '<span style="color:{};">{}</span>',
                color_code,ret)
    salestarget_24_q4.admin_order_field = '-salestarget2__q4target'
...
#目标完成月
    ...
    completemonth_23_q1.admin_order_field = 'salestarget2__q1completemonth'
    ...
    completemonth_23_q2.admin_order_field = 'salestarget2__q2completemonth'
    ...
    completemonth_23_q3.admin_order_field = 'salestarget2__q3completemonth'
    ...
    completemonth_23_q4.admin_order_field = 'salestarget2__q4completemonth'    
    ...
    completemonth_24_q1.admin_order_field = 'salestarget2__q1completemonth'
    ...
    completemonth_24_q2.admin_order_field = 'salestarget2__q2completemonth'
    ...
    completemonth_24_q3.admin_order_field = 'salestarget2__q3completemonth'
    ...
    completemonth_24_q4.admin_order_field = 'salestarget2__q4completemonth'

#23年全年实际完成额
    @admin.display(description='23年开票额')
    def actualsales_2023(self, obj):
        return '{:,.0f}'.format(obj.salestarget2_set.filter(year='2023',is_active=True)[0].q1actualsales+obj.salestarget2_set.filter(year='2023',is_active=True)[0].q2actualsales+obj.salestarget2_set.filter(year='2023',is_active=True)[0].q3actualsales+obj.salestarget2_set.filter(year='2023',is_active=True)[0].q4actualsales)
    actualsales_2023.admin_order_field = '-actualsales_2023'

#每季度实际完成额
    @admin.display(description='23/Q1实际')
    def actualsales_23_q1(self, obj):
        return '{:,.0f}'.format(obj.salestarget2_set.filter(year='2023',is_active=True)[0].q1actualsales)
    actualsales_23_q1.admin_order_field = '-salestarget2__q1actualsales'

    @admin.display(description='23/Q2实际')
    def actualsales_23_q2(self, obj):
        return '{:,.0f}'.format(obj.salestarget2_set.filter(year='2023',is_active=True)[0].q2actualsales)
    actualsales_23_q2.admin_order_field = '-salestarget2__q2actualsales'
    
    @admin.display(description='23/Q3实际')
    def actualsales_23_q3(self, obj):
        return '{:,.0f}'.format(obj.salestarget2_set.filter(year='2023',is_active=True)[0].q3actualsales)
    actualsales_23_q3.admin_order_field = '-salestarget2__q3actualsales'

    @admin.display(description='23/Q4实际')
    def actualsales_23_q4(self, obj):
        return '{:,.0f}'.format(obj.salestarget2_set.filter(year='2023',is_active=True)[0].q4actualsales)
    actualsales_23_q4.admin_order_field = '-salestarget2__q4actualsales'
...
#每季度实际完成率
    ...
    def finishrate_23_q1(self, obj):
        sales_target = obj.salestarget2_set.filter(year='2023',is_active=True)[0]
        if sales_target.q1target and sales_target.q1target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_23_q1.admin_order_field = '-salestarget2__q1finishrate'
    ...
    def finishrate_23_q2(self, obj):
        ...
        if sales_target.q2target and sales_target.q2target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_23_q2.admin_order_field = '-salestarget2__q2finishrate'
    ...
    def finishrate_23_q3(self, obj):
        ...
        if sales_target.q3target and sales_target.q3target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_23_q3.admin_order_field = '-salestarget2__q3finishrate'
    ...
    def finishrate_23_q4(self, obj):
        ...
        if sales_target.q4target and sales_target.q4target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_23_q4.admin_order_field = '-salestarget2__q4finishrate'
    
    @admin.display(description='24/Q1完成率')
    def finishrate_24_q1(self, obj):
        sales_target = obj.salestarget2_set.filter(year='2024',is_active=True)[0]
        if sales_target.q1target and sales_target.q1target != 0:#如果target不是0
            finishrate = sales_target.q1actualsales / sales_target.q1target
            sales_target.q1finishrate = finishrate
            sales_target.save()
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_24_q1.admin_order_field = '-salestarget2__q1finishrate'
    ...
    def finishrate_24_q2(self, obj):
        ...
        if sales_target.q2target and sales_target.q2target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_24_q2.admin_order_field = '-salestarget2__q2finishrate'
    ...
    def finishrate_24_q3(self, obj):
        ...
        if sales_target.q3target and sales_target.q3target != 0:#如果target不是0
            ...
            sales_target.save()
            return '{:.1f}%'.format(finishrate*100)        
    finishrate_24_q3.admin_order_field = '-salestarget2__q3finishrate'
...
#考虑直接在calculatedetail中匹配？？！！！
            ...
            samehospital=PMRResearchList2.objects.filter(Q(hospital_id=i.hospital.id))
            for x in samehospital:
                if not x.contactname:
