...
def get_compmany_default_value():
    return Company.objects.get(id=12).company

class XYUserInfo(UserInfo):   
...
class XYSalesmanPosition(models.Model):
    # id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('XYUserInfo', models.CASCADE, db_column='user',to_field='id') #settings.AUTH_USER_MODEL
...
class XYOverall(models.Model):
    ...
    company = models.ForeignKey('Company', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_compmany_default_value)
    salesman = models.ForeignKey('XYUserInfo', models.CASCADE, db_column='salesman',to_field='id',related_name='salesmanxyoverall',verbose_name= '负责人',default=25)
    ...
    operator = models.ForeignKey('XYUserInfo', models.CASCADE, db_column='operator',to_field='id',related_name='operatorxyoverall',verbose_name= '最后操作人')   
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now=True)
    is_active=models.BooleanField(verbose_name='是否呈现',null=False, default = True)
...
#新项目---------------------
class XYNewProjectStatus(models.Model):
    ...
    progress_choices = (
        ...
        ('仪器装机启用', '仪器装机启用'),
        ('仪器试剂均开票','仪器试剂均开票'))
    overallid = models.ForeignKey('XYOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
...
class XYNewProjectDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYNewProjectStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class XYNegotiationStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class XYNegotiationDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYNegotiationStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    productid =  models.ForeignKey('XYMenu', models.CASCADE, db_column='productid',to_field='id',verbose_name= '产品信息:名称_规格_单位_采购价_供应商_品牌',blank=True, null=True)###
    code = models.CharField(verbose_name='产品编码U8 ',max_length=255, blank=True, null=True)##
    product = models.CharField(verbose_name='产品名称U8',help_text=u"请按系统名称填报",max_length=255, blank=True, null=True)###
    spec = models.CharField(verbose_name='规格',max_length=255, blank=True, null=True)###
    unit = models.CharField(verbose_name='单位',max_length=255, blank=True, null=True)###
...
class XYChangeChannelStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class XYChangeChannelDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYChangeChannelStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class XYChangeBrandStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
#品牌替换前
class XYBeforeChangeBrandDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYChangeBrandStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
#品牌替换后
class XYAfterChangeBrandDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYChangeBrandStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
class XYSetStatus(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
...
class XYSetDetail(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XYSetStatus', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
...
#=====================================
class XYCalculate(models.Model):
    overallid = models.OneToOneField('XYOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
...
class XYMenu(models.Model):
    overallid = models.ForeignKey('XYOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=0)
...
#普中心大菜单给inline展示用的
class XYMenuforinline(models.Model):
    overallid = models.ForeignKey('XYOverall', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=1)
