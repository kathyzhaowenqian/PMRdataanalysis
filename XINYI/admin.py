...
from django.contrib import admin
from XINYI.models import *
from XINYI.models_delete import *
...
#----------FORM-------LIST--------
class XYOverallForm(forms.ModelForm):
...
class XYNewProjectDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYNewProjectDetail
            exclude = ['id']
            widgets = {
...
class XYNegotiationDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # print('aaaaaaaaaaaaaaaaaaaaaaaaaaa')
        self.fields['productid'].queryset =  XYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XYNegotiationDetail
            exclude = ['id']
            widgets = {
...
class XYChangeChannelDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  XYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XYChangeChannelDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class XYBeforeChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  XYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XYBeforeChangeBrandDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class XYAfterChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYAfterChangeBrandDetail
            exclude = ['id']
            widgets = {
                'originalsupplier': forms.TextInput(attrs={'size':'10'}),
                'originalbrand': forms.TextInput(attrs={'size':'5'}),
...
class XYSetDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class XYNewProjectStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYNewProjectStatus
            exclude = ['id']
            widgets = {
...
class XYNegotiationStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYNegotiationStatus
            exclude = ['id']
            widgets = {
...
class XYChangeChannelStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYChangeChannelStatus
            exclude = ['id']
            widgets = {
...
class XYChangeBrandStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XYChangeBrandStatus
            exclude = ['id']
            widgets = {
...
class XYSetStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class XYMenuforinlineInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
#---------------------------------------------------------------
#新开项目明细的内嵌inline
class XYNewProjectDetailInline(nested_admin.NestedTabularInline):
    form=XYNewProjectDetailInlineForm
    model = XYNewProjectDetail
    fk_name = "progressid"
    extra = 0
    ...
    view_group_list = ['boss','XY','allviewonly','JConlyview']
    ...
    def has_add_permission(self,request,obj):
        print('XYNewProjectDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNewProjectDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYNewProjectDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNewProjectDetailInline has change permission:::obj',False)
            return False
        
#新开项目状态的内嵌inline
class XYNewProjectStatusInline(nested_admin.NestedStackedInline):
    form=XYNewProjectStatusInlineForm
    inlines=[XYNewProjectDetailInline]
    model = XYNewProjectStatus
    # fk_name = "overallid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XYNewProjectStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNewProjectStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYNewProjectStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNewProjectStatusInline has change permission:::obj',False)
            return False

#----------------------------------------------------------------
#供应商重新谈判明细的内嵌inline
class XYNegotiationDetailInline(nested_admin.NestedTabularInline):
    form=XYNegotiationDetailInlineForm
    model = XYNegotiationDetail
    extra = 0
    ...
    def get_queryset(self, request):
       ...
       #普通销售的话:
        ...
        # return qs.filter((Q(is_active=True)&Q(researchlist__salesman1=request.user))|(Q(is_active=True)&Q(researchlist__salesman2=request.user)))
    def has_add_permission(self,request,obj):
        print('XYNegotiationDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNegotiationDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYNegotiationDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNegotiationDetailInline has change permission:::obj',False)
            return False



#供应商重新谈判状态的内嵌inline
class XYNegotiationStatusInline(nested_admin.NestedStackedInline):
    form=XYNegotiationStatusInlineForm
    inlines=[XYNegotiationDetailInline]
    model = XYNegotiationStatus
    fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('XYNegotiationStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNegotiationStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYNegotiationStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYNegotiationStatusInline has change permission:::obj',False)
            return False
...
#----------------------------------------------------------------
#渠道变更明细的内嵌inline
class XYChangeChannelDetailInline(nested_admin.NestedTabularInline):
    form=XYChangeChannelDetailInlineForm
    model = XYChangeChannelDetail
    # fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_recentsales','field_recentcost','field_recentgp','field_recentgpofsupplier','field_estmonthlygpgrowth')#'field_lissettleprice') 
    ...
    def has_add_permission(self,request,obj):
        print('XYChangeChannelDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYChangeChannelDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYChangeChannelDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYChangeChannelDetailInline has change permission:::obj',False)
            return False

#渠道变更状态的内嵌inline
class XYChangeChannelStatusInline(nested_admin.NestedStackedInline):
    form=XYChangeChannelStatusInlineForm
    inlines=[XYChangeChannelDetailInline]
    model = XYChangeChannelStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('XYChangeChannelStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYChangeChannelStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYChangeChannelStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYChangeChannelStatusInline has change permission:::obj',False)
            return False
#-----------------------------------------------------------------
#品牌替换前明细的内嵌inline
class XYBeforeChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=XYBeforeChangeBrandDetailInlineForm
    model = XYBeforeChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XYBeforeChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYBeforeChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYBeforeChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYBeforeChangeBrandDetailInline has change permission:::obj',False)
            return False



#品牌替换后明细的内嵌inline
class XYAfterChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=XYAfterChangeBrandDetailInlineForm
    model = XYAfterChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XYAfterChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYAfterChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XYAfterChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XY':
            return True
        else:
            print('XYAfterChangeBrandDetailInline has change permission:::obj',False)
            return False


#品牌替换状态的内嵌inline
class XYChangeBrandStatusInline(nested_admin.NestedStackedInline):
    form= XYChangeBrandStatusInlineForm
    inlines=[XYBeforeChangeBrandDetailInline,XYAfterChangeBrandDetailInline]
    model =  XYChangeBrandStatus
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    fields=(('progress','completemonth'),
...
#-----------------------------------------------------------------
#套餐绑定明细的内嵌inline
class XYSetDetailInline(nested_admin.NestedTabularInline):
    form=XYSetDetailInlineForm
    model = XYSetDetail
    fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_estmonthlygpgrowth',) #'costfeepercent','marketpricefeepercent', 'newcostfeepercent') #'field_lissettleprice', 'field_recentgp',
...
#套餐绑定状态的内嵌inline
class XYSetStatusInline(nested_admin.NestedStackedInline):
    form=XYSetStatusInlineForm
    inlines=[XYSetDetailInline]
    model = XYSetStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
#----------------------------------------------------------------
#作战计划计算表
class XYCalculateInline(nested_admin.NestedStackedInline):
    model = XYCalculate
    # fk_name = "overallid"
    extra = 0
...
#----------------------------------------------------------------
#该科室该项目大类的相关产品明细'
class XYMenuforinlineInline(nested_admin.NestedTabularInline):
    model = XYMenuforinline
    form=XYMenuforinlineInlineForm
    # fk_name = "overallid"
    extra = 0
    # readonly_fields = ('estnewgpgrowth','realnewgpgrowth','newgpgrowthpercent',
    #                     'estnegogpgrowth','realnegogpgrowth','negogpgrowthpercent',
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!``````````````````````````````````````
#作战计划总表
@admin.register(XYOverall)
class XYOverallAdmin(nested_admin.NestedModelAdmin):
    form = XYOverallForm
    inlines=[XYMenuforinlineInline,XYNewProjectStatusInline,XYNegotiationStatusInline,XYChangeChannelStatusInline,XYChangeBrandStatusInline,XYSetStatusInline,XYCalculateInline]
    exclude = ('id','createtime','updatetime','is_active','operator')
    search_fields=['department','semidepartment','project','supplier','xymenuforinline__product']
    ...
    #把项目的id放入redis，方便下面的XYMENU来获取对应id的details
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        if not existed_redis_data:
            ...
            print(cache.set(username,existed_redis_data,None),'XYOverallAdmin(nested_admin.NestedModelAdmin)')
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'company': 
            kwargs["queryset"] = Company.objects.filter(is_active=True,id=12) 
        if db_field.name == 'salesman': 
            kwargs["queryset"] = UserInfo.objects.filter(Q(is_active=True) & Q(username__in= ['ny']))
        return super().formfield_for_foreignkey(db_field, request, **kwargs)
    

    # ------delete_model内层的红色删除键------------------------------
    def delete_model(self, request, obj):
        print('XY delete_model')
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or obj.salesman==request.user:             
            obj.is_active = False 
            obj.operator=request.user   
            if XYNewProjectStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xynewprojectstatus_set.all().update(is_active=False)
            if  XYNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XYNegotiationStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xynegotiationstatus_set.all().update(is_active=False)
            if  XYNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XYChangeChannelStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xychangechannelstatus_set.all().update(is_active=False)
            if  XYChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XYChangeBrandStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xychangebrandstatus_set.all().update(is_active=False)
            if  XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)
            if  XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XYSetStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xysetstatus_set.all().update(is_active=False)
            if  XYSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XYSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            # if XYMenu.objects.filter(overallid__id=obj.id,is_active=True):
            #     obj.xymenu_set.all().update(is_active=False)
   
            if  XYCalculate.objects.filter(overallid__id=obj.id,is_active=True):   
                obj.xycalculate.is_active=False
                obj.xycalculate.save()
    ...
    def delete_queryset(self,request, queryset):        
            ...
            for delete_obj in queryset:     
                ...
                if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or delete_obj.salesman==request.user:     
                    ...
                    if XYNewProjectStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xynewprojectstatus_set.all().update(is_active=False)
                    if  XYNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if XYNegotiationStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xynegotiationstatus_set.all().update(is_active=False)
                    if  XYNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  XYChangeChannelStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xychangechannelstatus_set.all().update(is_active=False)
                    if  XYChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if XYChangeBrandStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xychangebrandstatus_set.all().update(is_active=False)
                    if  XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    if  XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    
                    if XYSetStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xysetstatus_set.all().update(is_active=False)
                    if  XYSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XYSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  XYCalculate.objects.filter(overallid__id=delete_obj.id,is_active=True):   
                        delete_obj.xycalculate.is_active=False
                        delete_obj.xycalculate.save()
                    delete_obj.save()
    ...
    def save_related(self, request, form, formsets, change): 
        ...
        for eachformset in formsets: #循环每一个增量来源及明细,删除多填的信息
            ...
            if eachformset.model==XYNewProjectStatus:
                # print('eachformset-------XYNewProjectStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XYNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XYNewProjectDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
            ...
            if eachformset.model==XYNegotiationStatus:
                # print('eachformset------XYNegotiationStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.form)
                statusobjs=XYNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XYNegotiationDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()
                if statusobjs:
                    print('statusobjs[0]',statusobjs[0])
            ...
            if eachformset.model==XYChangeChannelStatus:
                # print('eachformset-------XYChangeChannelStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XYChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XYChangeChannelDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()  
                if statusobjs:   
                    whygrowth+='渠道变更,'

            if eachformset.model==XYChangeBrandStatus:
                # print('eachformset-------XYChangeBrandStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XYChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XYBeforeChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        detailobjs2=XYAfterChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs2.update(is_active=False)
                        statusobjs[i].delete() 
                if statusobjs: 
                    whygrowth+='品牌替换,'

            if eachformset.model==XYSetStatus:
                # print('eachformset-------XYSetStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XYSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XYSetDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)       
                        statusobjs[i].delete()  
                if statusobjs:
                    whygrowth+='套餐绑定,'
        ...
        for eachdetail in XYNewProjectDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
        ...
        if  XYNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            newprojectobject= XYNewProjectStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XYNegotiationDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            '''# print('eachdetail',eachdetail)
            ...
            # eachdetail.save()
            # #recentsales半年度开票额=半年度采购数量/单位 X 每单位人份数 X LIS收费单价 X LIS结算%）** 按采购量来，除非开票额是按医院给的填的
            # eachdetail.recentsales=eachdetail.purchaseqty*eachdetail.pplperunit*eachdetail.lisfee*eachdetail.lispercent
            # #recentcost半年度采购额 =（半年度采购数量/单位 X 采购价/单位） 
            # eachdetail.recentcost=eachdetail.purchaseqty*eachdetail.costperunit
            # #recentgp半年度盈亏额 =（ 开票额 - 采购额）
            # eachdetail.recentgp=eachdetail.purchaseqty*eachdetail.pplperunit*eachdetail.lisfee*eachdetail.lispercent-eachdetail.purchaseqty*eachdetail.costperunit
            ...
            # #LIS结算价（开票价） =（ LIS收费价 *  LIS结算%）
            # eachdetail.lissettleprice=eachdetail.lisfee*eachdetail.lispercent
            # #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
            # eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
            # #gppercent毛利率 （呈现%）  =  （LIS收费价 *  LIS结算%  -  采购价每单位 / 每单位人份数）/（LIS收费价 *  LIS结算%）
            # eachdetail.gppercent=((eachdetail.lisfee*eachdetail.lispercent)-(eachdetail.costperunit/eachdetail.pplperunit))/(eachdetail.lisfee*eachdetail.lispercent)
            # #costfeepercent原采购价占收费比例 =（（采购价每单位 / 每单位人份数 ） /  LIS收费价 ）
            # eachdetail.costfeepercent=(eachdetail.costperunit/eachdetail.pplperunit)/eachdetail.lisfee
            # #marketpricefeepercent市场价占收费比例 =  （市场价/人份    /  LIS收费价 ）
            # eachdetail.marketpricefeepercent=eachdetail.marketprice/eachdetail.lisfee
            ...
            # eachdetail.newgppercent=((eachdetail.lisfee*eachdetail.lispercent)-eachdetail.newcostppl)/(eachdetail.lisfee*eachdetail.lispercent)
            # #newcostfeepercent新采购价占收费比例  =（新采购价/人份    /  LIS收费价 ）
            # eachdetail.newcostfeepercent=eachdetail.newcostppl/eachdetail.lisfee
            # #targetdropdate谈判下降比例 = （（谈判目标/元    -   （采购价每单位 / 每单位人份数） ）/ （采购价每单位 / 每单位人份数））
            # eachdetail.targetdropdate=-(eachdetail.targetppl  - (eachdetail.costperunit/eachdetail.pplperunit))/(eachdetail.costperunit/eachdetail.pplperunit)
        ...
        if XYNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('negotiationobject',XYNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            negotiationobject= XYNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XYChangeChannelDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code)            
            eachdetail.originalbrand=eachdetail.productid.brand
            eachdetail.spec=eachdetail.productid.spec
        ...
        if XYChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changechannelobject',XYChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changechannelobject= XYChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            # print('eachdetail',eachdetail)
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code) 
            eachdetail.originalsupplier=eachdetail.productid.supplier
        ...
        for eachdetail in XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
        ...
        if XYChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changebrandobject',XYChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changebrandobject= XYChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XYSetDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
            #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
            eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
            #gppercent毛利率 （呈现%）  =  （LIS收费价 *  LIS结算%  -  采购价每单位 / 每单位人份数）/（LIS收费价 *  LIS结算%）
        ...
        if  XYSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            setobject= XYSetStatus.objects.get(overallid__id=form.instance.id,is_active=True)
      ...
      #CALCULATE 用销售填报的月毛利额增量预估来填：
        if XYCalculate.objects.filter(overallid__id=form.instance.id,is_active=True):
            # print('原本有calculate：',XYCalculate.objects.get(overallid__id=form.instance.id,is_active=True))
            a=XYCalculate.objects.get(overallid__id=form.instance.id,is_active=True)
            a.estallgpgrowth=0
            a.estnewgpgrowth=0
            a.estnegogpgrowth=0    
            ...
            XYCalculate.objects.create(**XYCalculatedata).save()
        

        overallobject= XYOverall.objects.get(id=form.instance.id)
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=True,company_id=12)
 ...
 #新增动作————统计按钮
    ...
    def calculate(self, request, queryset):
        for i in queryset:
            ...
            relation=[]
            whygrowth=''
            if XYNewProjectStatus.objects.filter(overallid__id=i.id,is_active=True):
                newprojectobject = XYNewProjectStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += newprojectobject.monthgpgrowth 
                overallthisyeargpgrowth += newprojectobject.thisyeargpgrowth
                progresses.append(newprojectobject.progress)
                completemonths.append(str(newprojectobject.completemonth) if newprojectobject.completemonth else '--' )
                ...
                for eachdata in XYNewProjectDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XYNegotiationStatus.objects.filter(overallid__id=i.id,is_active=True):
                negotiationobject = XYNegotiationStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += negotiationobject.monthgpgrowth 
                overallthisyeargpgrowth += negotiationobject.thisyeargpgrowth
                progresses.append(negotiationobject.progress)
                completemonths.append(str(negotiationobject.completemonth) if negotiationobject.completemonth else '--' )
                ...
                for eachdata in XYNegotiationDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XYChangeChannelStatus.objects.filter(overallid__id=i.id,is_active=True):
                changechannelobject = XYChangeChannelStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changechannelobject.monthgpgrowth 
                overallthisyeargpgrowth += changechannelobject.thisyeargpgrowth
                progresses.append(changechannelobject.progress)
                completemonths.append(str(changechannelobject.completemonth) if changechannelobject.completemonth else '--' )
                ...
                for eachdata in XYChangeChannelDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XYChangeBrandStatus.objects.filter(overallid__id=i.id,is_active=True):
                changebrandobject = XYChangeBrandStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changebrandobject.monthgpgrowth 
                overallthisyeargpgrowth += changebrandobject.thisyeargpgrowth
                progresses.append(changebrandobject.progress)
                completemonths.append(str(changebrandobject.completemonth) if changebrandobject.completemonth else '--' )
                ...
                for eachdata in XYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
                    beforechangebrandmonthgp+=eachdata.monthgp
                for eachdata in XYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XYSetStatus.objects.filter(overallid__id=i.id,is_active=True):
                setobject = XYSetStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += setobject.monthgpgrowth 
                overallthisyeargpgrowth += setobject.thisyeargpgrowth
                progresses.append(setobject.progress)
                completemonths.append(str(setobject.completemonth) if setobject.completemonth else '--' )
                ...
                whygrowth+='套餐绑定,'
                setestgpgrowth=0      
                for eachdata in XYSetDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
    ...
    field_purchasesum.short_description = '项目1-6月采购额'
...
#----------------------------
    def field_supplierpurchasesum(self, obj):
        ...
        return format_html('<div>{}</div>',  '{:,.0f}'.format(value))
    field_supplierpurchasesum.short_description = '供应商1-6月采购额'
...
#----------------------------
    ...
    @admin.display(ordering="purchasesum",description=format_html('项目1-6月<br>采购额'))
...
#----------------------------
    ...
    @admin.display(ordering="supplierpurchasesum",description=format_html('供应商1-6月<br>采购额'))
...
#新开项目状态
@admin.register(XYNewProjectStatus)
class XYNewProjectStatusAdmin(nested_admin.NestedModelAdmin):
...
#新开项目明细
@admin.register(XYNewProjectDetail)
class XYNewProjectDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
...
#供应商重新谈判状态
@admin.register(XYNegotiationStatus)
class XYNegotiationStatusAdmin(nested_admin.NestedModelAdmin):
...
#供应商重新谈判明细
@admin.register(XYNegotiationDetail)
class XYNegotiationDetailAdmin(nested_admin.NestedModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'productid': 
            kwargs["queryset"] = XYMenu.objects.filter(is_active=True) 
        return super().formfield_for_foreignkey(db_field, request, **kwargs)
...
#渠道变更明细
@admin.register(XYChangeChannelDetail)
class XYChangeChannelDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换前明细
@admin.register(XYBeforeChangeBrandDetail)
class XYBeforeChangeBrandAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换后明细
@admin.register(XYAfterChangeBrandDetail)
class XYAfterChangeBrandDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
...
#套餐绑定明细
@admin.register(XYSetDetail)
class XYSetDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
    list_display = ('progressid__overallid__semidepartment','progressid__overallid__project','progressid__progress','originalsupplier','originalbrand',#newsupplier，beforeorafterbrandchange
                    'code','product','spec', 
...
@admin.register(XYMenu)  
class XYMenuAdmin(GlobalAdmin):   
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if 'autocomplete' in request.path:
            ...
            existed_redis_data = cache.get(username)
            if existed_redis_data:
                print(existed_redis_data,'class XYMenuAdmin(GlobalAdmin): ~~~~~~~~~~~~~~~')
...
@admin.register(XYOverallDELETE)
class XYOverallDELETEAdmin(admin.ModelAdmin):
    exclude = ('id','createtime','updatetime','is_active','operator')
 ...
 #只显示未被假删除的项目
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=False,company_id=12)
    ...
    def restore(self, request, queryset):
        ...
        print('我在restore')      
        for i in queryset:
            # print(i.xynewprojectstatusdelete_set.all())
            i.xynewprojectstatusdelete_set.all().update(is_active=True)
            for j in i.xynewprojectstatusdelete_set.all():
                if hasattr(j, 'xynewprojectdetaildelete_set'):
                    j.xynewprojectdetaildelete_set.all().update(is_active=True)

            i.xynegotiationstatusdelete_set.all().update(is_active=True)
            for j in i.xynegotiationstatusdelete_set.all():
                # print('~~~~~!',j)
                # print('all',j.xynegotiationdetaildelete_set.all())
                if hasattr(j, 'xynegotiationdetaildelete_set'):
                    # print("~~~~~hasattrxynegotiationdetaildelete", j.xynegotiationdetaildelete_set.all())
                    j.xynegotiationdetaildelete_set.all().update(is_active=True)

            i.xychangechannelstatusdelete_set.all().update(is_active=True)
            for j in i.xychangechannelstatusdelete_set.all():
                # print('~~~~~~',j)
                if hasattr(j, 'xychangechanneldetaildelete_set'):
                    # print("~~~~~", j.xychangechanneldetaildelete_set.all())
                    j.xychangechanneldetaildelete_set.all().update(is_active=True)

            i.xychangebrandstatusdelete_set.all().update(is_active=True)
            
            for j in i.xychangebrandstatusdelete_set.all():
                if hasattr(j, 'xychangebranddetaildelete_set'):
                    j.xychangebranddetaildelete_set.all().update(is_active=True)

            i.xysetstatusdelete_set.all().update(is_active=True)
            for j in i.xysetstatusdelete_set.all():
                if hasattr(j, 'xysetdetaildelete_set'):
                    j.xysetdetaildelete_set.all().update(is_active=True)

            if hasattr(i, 'xycalculatedelete'):
                i.xycalculatedelete.is_active=True
                i.xycalculatedelete.save()  
            print('恢复') 
