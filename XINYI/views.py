...
class XYgantt(View):
    ...
    def post(self,request):
        ...
        NewProjectStatus_queryset = XYNewProjectStatus.objects.values('statushistory').filter(is_active=True)
        NegotiationStatus_queryset = XYNegotiationStatus.objects.values('statushistory').filter(is_active=True)
        ChangeChannelStatus_queryset = XYChangeChannelStatus.objects.values('statushistory').filter(is_active=True)
        ChangeBrandStatus_queryset = XYChangeBrandStatus.objects.values('statushistory').filter(is_active=True)
        SetStatus_queryset = XYSetStatus.objects.values('statushistory').filter(is_active=True)
