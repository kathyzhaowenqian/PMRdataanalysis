...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='XYAfterChangeBrandDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='XYBeforeChangeBrandDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='XYChangeBrandStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='XYChangeChannelDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='XYChangeChannelStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer', models.CharField(default='新沂', max_length=255, verbose_name='客户')),
        ...
        migrations.CreateModel(
            name='XYNegotiationDetailDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='XYNegotiationStatusDELETE',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whygrowth', multiselectfield.db.fields.MultiSelectField(choices=[('新开项目', '新开项目'), ('供应商重新谈判', '供应商重新谈判'), ('渠道变更', '渠道变更'), ('品牌替换', '品牌替换'), ('套餐绑定', '套餐绑定'), ('--', '--')], help_text='（按住Ctrl键可多选, 选择后, 请在下方填写每一个增量来源的详情）', max_length=25, verbose_name='增量来源')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('company', models.ForeignKey(db_column='company', default=XINYI.models.get_compmany_default_value, on_delete=django.db.models.deletion.CASCADE, to='XINYI.company', verbose_name='公司')),
                ('operator', models.ForeignKey(db_column='operator', on_delete=django.db.models.deletion.CASCADE, related_name='operatorxyoverall', to='XINYI.xyuserinfo', verbose_name='最后操作人')),
                ('salesman', models.ForeignKey(db_column='salesman', default=25, on_delete=django.db.models.deletion.CASCADE, related_name='salesmanxyoverall', to='XINYI.xyuserinfo', verbose_name='负责人')),
            ],
            options={
                'verbose_name_plural': '作战计划',
                'db_table': 'marketing_research_v2"."XYPlanOverall',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xyoverall', verbose_name='作战计划')),
            ],
            options={
                'verbose_name_plural': '套餐绑定状态',
                'db_table': 'marketing_research_v2"."XYSetStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xysetstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '套餐绑定明细',
                'db_table': 'marketing_research_v2"."XYSetDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xynewprojectstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '新开项目明细',
                'db_table': 'marketing_research_v2"."XYNewProjectDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XINYI.xymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xynegotiationstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '供应商重新谈判明细',
                'db_table': 'marketing_research_v2"."XYNegotiationDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', default=1, on_delete=django.db.models.deletion.CASCADE, to='XINYI.xyoverall', verbose_name='主表id')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='xymenu',
            name='overallid',
            field=models.ForeignKey(db_column='overallid', default=0, on_delete=django.db.models.deletion.CASCADE, to='XINYI.xyoverall', verbose_name='主表id'),
        ),
        migrations.CreateModel(
            name='XYChangeChannelStatus',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('whygrowth', models.CharField(default='渠道变更', max_length=255, verbose_name='增量来源')),
                ('progress', models.CharField(choices=[('待谈判', '待谈判'), ('已谈判等回复', '已谈判等回复'), ('新渠道价格已确认', '新渠道价格已确认')], default='待拜访', max_length=25, verbose_name='进度(必填)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XINYI.xymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xychangechannelstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '渠道变更明细',
                'db_table': 'marketing_research_v2"."XYChangeChannelDetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.OneToOneField(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xyoverall', verbose_name='作战计划')),
            ],
            options={
                'verbose_name_plural': '作战计划计算表',
                'db_table': 'marketing_research_v2"."XYCalculate',
        ...
        migrations.CreateModel(
            name='XYBeforeChangeBrandDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('whygrowth', models.CharField(default='品牌替换前', max_length=255, verbose_name='增量来源')),
                ('originalsupplier', models.CharField(blank=True, help_text='请按系统中供应商名称填报', max_length=255, null=True, verbose_name='供应商')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XINYI.xymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XINYI.xychangebrandstatus', verbose_name='进度状态')),
            ],
            options={
                'verbose_name_plural': '品牌替换前明细',
                'db_table': 'marketing_research_v2"."XYBeforeChangeBrandDetail',
