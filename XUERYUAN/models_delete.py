...
def get_compmany_default_value():
    return CompanyDELETE.objects.get(id=14).company

class XEYUserInfoDELETE(UserInfo):   
...
class XEYSalesmanPositionDELETE(models.Model):
    # id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('XEYUserInfoDELETE', models.CASCADE, db_column='user',to_field='id') #settings.AUTH_USER_MODEL
...
#============================================================
class XEYOverallDELETE(models.Model):
    whygrowth_choices=[       
        ('新开项目', '新开项目'),
        ('供应商重新谈判', '供应商重新谈判'),
        ('渠道变更', '渠道变更'),
        ...
        ('--', '--'),]
    company = models.ForeignKey('CompanyDELETE', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_compmany_default_value)
    salesman = models.ForeignKey('XEYUserInfoDELETE', models.CASCADE, db_column='salesman',to_field='id',related_name='salesmanxeyoveralldelete',verbose_name= '负责人',default=25)
    ...
    operator = models.ForeignKey('XEYUserInfoDELETE', models.CASCADE, db_column='operator',to_field='id',related_name='operatorxeyoveralldelete',verbose_name= '最后操作人')   
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now=True)
    is_active=models.BooleanField(verbose_name='是否呈现',null=False, default = True)
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYPlanOverall'
...
#新项目---------------------
class XEYNewProjectStatusDELETE(models.Model):
    ...
    progress_choices = (
        ...
        ('仪器装机启用', '仪器装机启用'),
        ('仪器试剂均开票','仪器试剂均开票'))
    overallid = models.ForeignKey('XEYOverallDELETE', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYNewProjectStatus'
...
class XEYNewProjectDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYNewProjectStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYNewProjectDetail'
...
class XEYNegotiationStatusDELETE(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYNegotiationStatus'
...
class XEYNegotiationDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYNegotiationStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    productid =  models.ForeignKey('XEYMenuDELETE', models.CASCADE, db_column='productid',to_field='id',verbose_name= '产品信息:名称_规格_单位_采购价_供应商_品牌',blank=True, null=True)###
    code = models.CharField(verbose_name='产品编码U8 ',max_length=255, blank=True, null=True)##
    product = models.CharField(verbose_name='产品名称U8',help_text=u"请按系统名称填报",max_length=255, blank=True, null=True)###
    spec = models.CharField(verbose_name='规格',max_length=255, blank=True, null=True)###
    unit = models.CharField(verbose_name='单位',max_length=255, blank=True, null=True)###
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYNegotiationDetail'
...
class XEYChangeChannelStatusDELETE(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYChangeChannelStatus'
...
class XEYChangeChannelDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYChangeChannelStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYChangeChannelDetail'
        verbose_name_plural = '渠道变更明细'
    
    def delete(self, using=None, keep_parents=False):
        #即使在inline中也是假删除
        """重写数据库删除方法实现逻辑删除"""
        print(self,'我在model中的 XEY渠道变更明细删除')
        self.is_active = False
        self.save()
...
class XEYChangeBrandStatusDELETE(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYChangeBrandStatus'
...
#品牌替换前
class XEYBeforeChangeBrandDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYChangeBrandStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYBeforeChangeBrandDetail'
        verbose_name_plural = '品牌替换前明细'
    
    def delete(self, using=None, keep_parents=False):
        #即使在inline中也是假删除
        """重写数据库删除方法实现逻辑删除"""
        print(self,'我在model中的 XEY品牌替换前明细删除')
        self.is_active = False
        self.save()


#品牌替换后
class XEYAfterChangeBrandDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYChangeBrandStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYAfterChangeBrandDetail'
        verbose_name_plural = '品牌替换后明细'
    
    def delete(self, using=None, keep_parents=False):
        #即使在inline中也是假删除
        """重写数据库删除方法实现逻辑删除"""
        print(self,'我在model中的 XEY品牌替换后明细删除')
        self.is_active = False
        self.save()
...
class XEYSetStatusDELETE(models.Model):
    completemonth_choices = (
        (1, 1),
        (2, 2),
        (3, 3),
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYSetStatus'
...
class XEYSetDetailDELETE(models.Model):
    brand_choices = (
        ('置换前', '置换前'),
        ('置换后', '置换后'),)
    progressid = models.ForeignKey('XEYSetStatusDELETE', models.CASCADE, db_column='progressid',to_field='id',verbose_name= '进度状态')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYSetDetail'
        verbose_name_plural = '套餐绑定明细'
    
    def delete(self, using=None, keep_parents=False):
        #即使在inline中也是假删除
        """重写数据库删除方法实现逻辑删除"""
        print(self,'我在model中的 XEY套餐绑定明细删除')
        self.is_active = False
        self.save()
...
#=====================================
class XEYCalculateDELETE(models.Model):
    overallid = models.OneToOneField('XEYOverallDELETE', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '作战计划')
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYCalculate'
        verbose_name_plural = '作战计划计算表'
    
 
#========
#徐二院大菜单给供应商重新谈判的筛选用的
class XEYMenuDELETE(models.Model):
    overallid = models.ForeignKey('XEYOverallDELETE', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=1)

    customer = models.CharField(verbose_name='客户',max_length=255, default='徐二院')
    department = models.CharField(verbose_name='科室',max_length=255, blank=True, null=True)
    semidepartment = models.CharField(verbose_name='使用科室',max_length=255, blank=True, null=True)
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYMenu'
        verbose_name_plural = '徐二院大菜单作筛选'
    def __str__(self):
...
#徐二院大菜单给inline展示用的
class XEYMenuforinlineDELETE(models.Model):
    overallid = models.ForeignKey('XEYOverallDELETE', models.CASCADE, db_column='overallid',to_field='id',verbose_name= '主表id',default=1)
    ...
    class Meta:
        managed=False
        db_table = 'marketing_research_v2\".\"XEYMenuforinline'
        verbose_name_plural = '徐二院大菜单作展示'
