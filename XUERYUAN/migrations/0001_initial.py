# Generated by Django 3.2 on 2023-08-22 05:30

import XUERYUAN.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer', models.CharField(default='徐二院', max_length=255, verbose_name='客户')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('company', models.ForeignKey(db_column='company', default=XUERYUAN.models.get_compmany_default_value, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.company', verbose_name='公司')),
                ('operator', models.ForeignKey(db_column='operator', on_delete=django.db.models.deletion.CASCADE, related_name='operatorxeyoverall', to='XUERYUAN.xeyuserinfo', verbose_name='最后操作人')),
                ('salesman', models.ForeignKey(db_column='salesman', default=25, on_delete=django.db.models.deletion.CASCADE, related_name='salesmanxeyoverall', to='XUERYUAN.xeyuserinfo', verbose_name='负责人')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeyoverall', verbose_name='作战计划')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeysetstatus', verbose_name='进度状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeynewprojectstatus', verbose_name='进度状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeynegotiationstatus', verbose_name='进度状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.ForeignKey(db_column='overallid', default=1, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeyoverall', verbose_name='主表id')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='xeymenu',
            name='overallid',
            field=models.ForeignKey(db_column='overallid', default=0, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeyoverall', verbose_name='主表id'),
        ),
        migrations.CreateModel(
            name='XEYChangeChannelStatus',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeychangechannelstatus', verbose_name='进度状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('overallid', models.OneToOneField(db_column='overallid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeyoverall', verbose_name='作战计划')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='XEYBeforeChangeBrandDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='是否呈现')),
                ('productid', models.ForeignKey(blank=True, db_column='productid', null=True, on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeymenu', verbose_name='产品信息:名称_规格_单位_采购价_供应商_品牌')),
                ('progressid', models.ForeignKey(db_column='progressid', on_delete=django.db.models.deletion.CASCADE, to='XUERYUAN.xeychangebrandstatus', verbose_name='进度状态')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='XEYAfterChangeBrandDetail',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
