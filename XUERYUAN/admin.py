...
from XUERYUAN.models import *
from XUERYUAN.models_delete import *
...
@admin.register(XEYUserInfo)  
class XEYUserAdmin(UserAdmin):  
...
#----------FORM-------LIST--------
class XEYOverallForm(forms.ModelForm):
...
class XEYNewProjectDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYNewProjectDetail
            exclude = ['id']
            widgets = {
...
class XEYNegotiationDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  XEYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XEYNegotiationDetail
            exclude = ['id']
            widgets = {
...
class XEYChangeChannelDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  XEYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XEYChangeChannelDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class XEYBeforeChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  XEYMenu.objects.filter(is_active=True)

    class Meta: 
            model = XEYBeforeChangeBrandDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class XEYAfterChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYAfterChangeBrandDetail
            exclude = ['id']
            widgets = {
                'originalsupplier': forms.TextInput(attrs={'size':'10'}),
                'originalbrand': forms.TextInput(attrs={'size':'5'}),
...
class XEYSetDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class XEYNewProjectStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYNewProjectStatus
            exclude = ['id']
            widgets = {
...
class XEYNegotiationStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYNegotiationStatus
            exclude = ['id']
            widgets = {
...
class XEYChangeChannelStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYChangeChannelStatus
            exclude = ['id']
            widgets = {
...
class XEYChangeBrandStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = XEYChangeBrandStatus
            exclude = ['id']
            widgets = {
...
class XEYSetStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class XEYMenuforinlineInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
#---------------------------------------------------------------
#新开项目明细的内嵌inline
class XEYNewProjectDetailInline(nested_admin.NestedTabularInline):
    form=XEYNewProjectDetailInlineForm
    model = XEYNewProjectDetail
    fk_name = "progressid"
    extra = 0
    ...
    view_group_list = ['boss','XEY','allviewonly','JConlyview']
    ...
    def has_add_permission(self,request,obj):
        print('XEYNewProjectDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNewProjectDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYNewProjectDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNewProjectDetailInline has change permission:::obj',False)
            return False
        
#新开项目状态的内嵌inline
class XEYNewProjectStatusInline(nested_admin.NestedStackedInline):
    form=XEYNewProjectStatusInlineForm
    inlines=[XEYNewProjectDetailInline]
    model = XEYNewProjectStatus
    # fk_name = "overallid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XEYNewProjectStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNewProjectStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYNewProjectStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNewProjectStatusInline has change permission:::obj',False)
            return False

#----------------------------------------------------------------
#供应商重新谈判明细的内嵌inline
class XEYNegotiationDetailInline(nested_admin.NestedTabularInline):
    form=XEYNegotiationDetailInlineForm
    model = XEYNegotiationDetail
    extra = 0
    ...
    def field_recentsales(self, obj):
        ...
        return format_html('<div style="{}">{}</div>', style,'{:,}'.format(value))
    field_recentsales.short_description = '1-8月开票额'

    def field_recentcost(self, obj):
        value = int(obj.recentcost) if obj.recentcost else 0
        style = 'width: 6ch'#; background-color: #f2f2f2;'
        return format_html('<div style="{}">{}</div>', style, '{:,}'.format(value))
    field_recentcost.short_description = '1-8月采购额'
    ...
    def get_queryset(self, request):
       ...
       #普通销售的话:
        ...
        # return qs.filter((Q(is_active=True)&Q(researchlist__salesman1=request.user))|(Q(is_active=True)&Q(researchlist__salesman2=request.user)))
    def has_add_permission(self,request,obj):
        print('XEYNegotiationDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNegotiationDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYNegotiationDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNegotiationDetailInline has change permission:::obj',False)
            return False

#供应商重新谈判状态的内嵌inline
class XEYNegotiationStatusInline(nested_admin.NestedStackedInline):
    form=XEYNegotiationStatusInlineForm
    inlines=[XEYNegotiationDetailInline]
    model = XEYNegotiationStatus
    fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('XEYNegotiationStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNegotiationStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYNegotiationStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYNegotiationStatusInline has change permission:::obj',False)
            return False
#----------------------------------------------------------------
#渠道变更明细的内嵌inline
class XEYChangeChannelDetailInline(nested_admin.NestedTabularInline):
    form=XEYChangeChannelDetailInlineForm
    model = XEYChangeChannelDetail
    # fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_recentsales','field_recentcost','field_recentgp','field_recentgpofsupplier','field_estmonthlygpgrowth')#'field_lissettleprice') 
    ...
    def has_add_permission(self,request,obj):
        print('XEYChangeChannelDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYChangeChannelDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYChangeChannelDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYChangeChannelDetailInline has change permission:::obj',False)
            return False

#渠道变更状态的内嵌inline
class XEYChangeChannelStatusInline(nested_admin.NestedStackedInline):
    form=XEYChangeChannelStatusInlineForm
    inlines=[XEYChangeChannelDetailInline]
    model = XEYChangeChannelStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    ...
    def has_add_permission(self,request,obj):
        print('XEYChangeChannelStatusInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYChangeChannelStatusInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYChangeChannelStatusInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYChangeChannelStatusInline has change permission:::obj',False)
            return False
#-----------------------------------------------------------------
#品牌替换前明细的内嵌inline
class XEYBeforeChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=XEYBeforeChangeBrandDetailInlineForm
    model = XEYBeforeChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XEYBeforeChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYBeforeChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYBeforeChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYBeforeChangeBrandDetailInline has change permission:::obj',False)
            return False



#品牌替换后明细的内嵌inline
class XEYAfterChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=XEYAfterChangeBrandDetailInlineForm
    model = XEYAfterChangeBrandDetail
    fk_name = "progressid"
    extra = 0
    ...
    def has_add_permission(self,request,obj):
        print('XEYAfterChangeBrandDetailInline has add permission:::obj',obj,request.user) 
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYAfterChangeBrandDetailInline has add permission:::,obj.salesman1 else',False)
            return False

    def has_change_permission(self,request, obj=None):
        print('XEYAfterChangeBrandDetailInline has change permission:: obj',obj)
        if obj==None:
            return True            
        elif  request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss'  or request.user.groups.values()[0]['name'] =='XEY':
            return True
        else:
            print('XEYAfterChangeBrandDetailInline has change permission:::obj',False)
            return False


#品牌替换状态的内嵌inline
class XEYChangeBrandStatusInline(nested_admin.NestedStackedInline):
    form= XEYChangeBrandStatusInlineForm
    inlines=[XEYBeforeChangeBrandDetailInline,XEYAfterChangeBrandDetailInline]
    model =  XEYChangeBrandStatus
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    fields=(('progress','completemonth'),
...
#-----------------------------------------------------------------
#套餐绑定明细的内嵌inline
class XEYSetDetailInline(nested_admin.NestedTabularInline):
    form=XEYSetDetailInlineForm
    model = XEYSetDetail
    fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_estmonthlygpgrowth',) #'costfeepercent','marketpricefeepercent', 'newcostfeepercent') #'field_lissettleprice', 'field_recentgp',
...
#套餐绑定状态的内嵌inline
class XEYSetStatusInline(nested_admin.NestedStackedInline):
    form=XEYSetStatusInlineForm
    inlines=[XEYSetDetailInline]
    model = XEYSetStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
#----------------------------------------------------------------
#作战计划计算表
class XEYCalculateInline(nested_admin.NestedStackedInline):
    model = XEYCalculate
    # fk_name = "overallid"
    extra = 0
...
#----------------------------------------------------------------
#该科室该项目大类的相关产品明细'
class XEYMenuforinlineInline(nested_admin.NestedTabularInline):
    model = XEYMenuforinline
    form=XEYMenuforinlineInlineForm
    # fk_name = "overallid"
    extra = 0
    # readonly_fields = ('estnewgpgrowth','realnewgpgrowth','newgpgrowthpercent',
    #                     'estnegogpgrowth','realnegogpgrowth','negogpgrowthpercent',
    ...
    field_theoreticalgppercent.short_description = '理论毛利率'
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!``````````````````````````````````````
#作战计划总表
@admin.register(XEYOverall)
class XEYOverallAdmin(nested_admin.NestedModelAdmin):
    form = XEYOverallForm
    inlines=[XEYMenuforinlineInline,XEYNewProjectStatusInline,XEYNegotiationStatusInline,XEYChangeChannelStatusInline,XEYChangeBrandStatusInline,XEYSetStatusInline,XEYCalculateInline]
    exclude = ('id','createtime','updatetime','is_active','operator')
    search_fields=['department','semidepartment','project','supplier','xeymenuforinline__product']
    ...
    #把项目的id放入redis，方便下面的XEYMENU来获取对应id的details
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        elif existed_redis_data:
            print(existed_redis_data,'existed_redis_data')
            existed_redis_data[project_name] = user_selected_data
            print(existed_redis_data,'elif')
            print(cache.set(username,existed_redis_data,None),'XEYOverallAdmin(nested_admin.NestedModelAdmin)')
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'company': 
            kwargs["queryset"] = Company.objects.filter(is_active=True,id=14) 
        if db_field.name == 'salesman': 
            kwargs["queryset"] = UserInfo.objects.filter(Q(is_active=True) & Q(username__in= ['pdh']))
        return super().formfield_for_foreignkey(db_field, request, **kwargs)
    

    # ------delete_model内层的红色删除键------------------------------
    def delete_model(self, request, obj):
        print('XEY delete_model')
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or obj.salesman==request.user:             
            obj.is_active = False 
            obj.operator=request.user   
            if XEYNewProjectStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xeynewprojectstatus_set.all().update(is_active=False)
            if  XEYNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XEYNegotiationStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xeynegotiationstatus_set.all().update(is_active=False)
            if  XEYNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XEYChangeChannelStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xeychangechannelstatus_set.all().update(is_active=False)
            if  XEYChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XEYChangeBrandStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xeychangebrandstatus_set.all().update(is_active=False)
            if  XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)
            if  XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if XEYSetStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.xeysetstatus_set.all().update(is_active=False)
            if  XEYSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                XEYSetDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            # if XEYMenu.objects.filter(overallid__id=obj.id,is_active=True):
            #     obj.xeymenu_set.all().update(is_active=False)
   
            if  XEYCalculate.objects.filter(overallid__id=obj.id,is_active=True):   
                obj.xeycalculate.is_active=False
                obj.xeycalculate.save()
    ...
    def delete_queryset(self,request, queryset):        
            ...
            for delete_obj in queryset:     
                ...
                if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or delete_obj.salesman==request.user:     
                    ...
                    if XEYNewProjectStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xeynewprojectstatus_set.all().update(is_active=False)
                    if  XEYNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if XEYNegotiationStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xeynegotiationstatus_set.all().update(is_active=False)
                    if  XEYNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  XEYChangeChannelStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xeychangechannelstatus_set.all().update(is_active=False)
                    if  XEYChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if XEYChangeBrandStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xeychangebrandstatus_set.all().update(is_active=False)
                    if  XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    if  XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    
                    if XEYSetStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.xeysetstatus_set.all().update(is_active=False)
                    if  XEYSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        XEYSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  XEYCalculate.objects.filter(overallid__id=delete_obj.id,is_active=True):   
                        delete_obj.xeycalculate.is_active=False
                        delete_obj.xeycalculate.save()
                    delete_obj.save()
    ...
    def save_related(self, request, form, formsets, change): 
        ...
        for eachformset in formsets: #循环每一个增量来源及明细,删除多填的信息
            ...
            if eachformset.model==XEYNewProjectStatus:
                # print('eachformset-------XEYNewProjectStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XEYNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XEYNewProjectDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
            ...
            if eachformset.model==XEYNegotiationStatus:
                # print('eachformset------XEYNegotiationStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.form)
                statusobjs=XEYNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XEYNegotiationDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()
                if statusobjs:
                    print('statusobjs[0]',statusobjs[0])
            ...
            if eachformset.model==XEYChangeChannelStatus:
                # print('eachformset-------XEYChangeChannelStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XEYChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XEYChangeChannelDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()  
                if statusobjs:   
                    whygrowth+='渠道变更,'

            if eachformset.model==XEYChangeBrandStatus:
                # print('eachformset-------XEYChangeBrandStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XEYChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XEYBeforeChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        detailobjs2=XEYAfterChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs2.update(is_active=False)
                        statusobjs[i].delete() 
                if statusobjs: 
                    whygrowth+='品牌替换,'

            if eachformset.model==XEYSetStatus:
                # print('eachformset-------XEYSetStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=XEYSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=XEYSetDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)       
                        statusobjs[i].delete()  
                if statusobjs:
                    whygrowth+='套餐绑定,'
        ...
        for eachdetail in XEYNewProjectDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
        ...
        if  XEYNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            newprojectobject= XEYNewProjectStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XEYNegotiationDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            ...
            if not eachdetail.skuhistory or eachdetail.skuhistory=='':
                ...
                #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
                eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
                #recentgpofsupplier1-8月供应商盈利额  =（1-8月采购数量/单位 X 每单位人份数 X（采购价/人份 -  市场价/人份 ) )
                ...
                #不确定是用lis结算价作为销售价 还是用 （recentsales（thereticalvalue）/ 1-8月采购数量每单位 ） /每单位人份数
                ...
                #targetdropdate谈判下降比例 = （（谈判目标/元    -   （采购价每单位 / 每单位人份数） ）/ （采购价每单位 / 每单位人份数））
                eachdetail.targetdropdate=-(eachdetail.targetppl  - (eachdetail.costperunit/eachdetail.pplperunit))/(eachdetail.costperunit/eachdetail.pplperunit)
                #realmonthlyppl月开票人份数=1-8月进货数量/单位 * 每单位人份数/8，  #【注意！！！看看到底是几个月】
                eachdetail.realmonthlyppl=eachdetail.purchaseqty*eachdetail.pplperunit/8
                #gpgrowthppl毛利额增量/人份 = （（采购价每单位 / 每单位人份数）- 谈判目标/元  或者  新采购价/人份 ）
                #estmonthlygpgrowth预估月毛利额增量=1-8月采购数量/单位 X 每单位人份数 / 6 X  （（采购价每单位 / 每单位人份数）- 谈判目标/元  或者 新采购价/人份 ）
                if eachdetail.newcostppl  != 0: #如果有新价格
                    ...
                    eachdetail.estmonthlygpgrowth=eachdetail.purchaseqty*eachdetail.pplperunit/8*((eachdetail.costperunit/eachdetail.pplperunit)-eachdetail.newcostppl)
                else:#否则用谈判目标算
                    eachdetail.gpgrowthppl=(eachdetail.costperunit/eachdetail.pplperunit)-eachdetail.targetppl
                    eachdetail.estmonthlygpgrowth=eachdetail.purchaseqty*eachdetail.pplperunit/8*((eachdetail.costperunit/eachdetail.pplperunit)-eachdetail.targetppl)
                ...
                #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
                eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
                #recentgpofsupplier1-8月供应商盈利额  =（1-8月采购数量/单位 X 每单位人份数 X（采购价/人份 -  市场价/人份 ) )  !!!!!!!!!!用新的采购价来算供应商的盈利值,还是原来的供应商
        ...
        if XEYNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('negotiationobject',XEYNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            negotiationobject= XEYNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XEYChangeChannelDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code)            
            eachdetail.originalbrand=eachdetail.productid.brand
            eachdetail.spec=eachdetail.productid.spec
        ...
        if XEYChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changechannelobject',XEYChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changechannelobject= XEYChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            # print('eachdetail',eachdetail)
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code) 
            eachdetail.originalsupplier=eachdetail.productid.supplier
            ...
            eachdetail.monthgp=eachdetail.purchaseqty/8 *(eachdetail.productid.priceperunit-eachdetail.costperunit)
            eachdetail.save()
            sku_history= [{'originalsupplier':eachdetail.originalsupplier,
                            'originalbrand':eachdetail.originalbrand,
                            'newsupplier':eachdetail.newsupplier,
        ...
        for eachdetail in XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
        ...
        if XEYChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changebrandobject',XEYChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changebrandobject= XEYChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in XEYSetDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
            #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
            eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
        ...
        if  XEYSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            setobject= XEYSetStatus.objects.get(overallid__id=form.instance.id,is_active=True)
      ...
      #CALCULATE 用销售填报的月毛利额增量预估来填：
        if XEYCalculate.objects.filter(overallid__id=form.instance.id,is_active=True):
            # print('原本有calculate：',XEYCalculate.objects.get(overallid__id=form.instance.id,is_active=True))
            a=XEYCalculate.objects.get(overallid__id=form.instance.id,is_active=True)
            a.estallgpgrowth=0
            a.estnewgpgrowth=0
            a.estnegogpgrowth=0    
            ...
            XEYCalculate.objects.create(**XEYCalculatedata).save()
        

        overallobject= XEYOverall.objects.get(id=form.instance.id)
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=True,company_id=14)
 ...
 #新增动作————统计按钮
    ...
    def calculate(self, request, queryset):
        for i in queryset:
            ...
            relation=[]
            whygrowth=''
            if XEYNewProjectStatus.objects.filter(overallid__id=i.id,is_active=True):
                newprojectobject = XEYNewProjectStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += newprojectobject.monthgpgrowth 
                overallthisyeargpgrowth += newprojectobject.thisyeargpgrowth
                progresses.append(newprojectobject.progress)
                completemonths.append(str(newprojectobject.completemonth) if newprojectobject.completemonth else '--' )
                ...
                for eachdata in XEYNewProjectDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XEYNegotiationStatus.objects.filter(overallid__id=i.id,is_active=True):
                negotiationobject = XEYNegotiationStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += negotiationobject.monthgpgrowth 
                overallthisyeargpgrowth += negotiationobject.thisyeargpgrowth
                progresses.append(negotiationobject.progress)
                completemonths.append(str(negotiationobject.completemonth) if negotiationobject.completemonth else '--' )
                ...
                for eachdata in XEYNegotiationDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XEYChangeChannelStatus.objects.filter(overallid__id=i.id,is_active=True):
                changechannelobject = XEYChangeChannelStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changechannelobject.monthgpgrowth 
                overallthisyeargpgrowth += changechannelobject.thisyeargpgrowth
                progresses.append(changechannelobject.progress)
                completemonths.append(str(changechannelobject.completemonth) if changechannelobject.completemonth else '--' )
                ...
                for eachdata in XEYChangeChannelDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XEYChangeBrandStatus.objects.filter(overallid__id=i.id,is_active=True):
                changebrandobject = XEYChangeBrandStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changebrandobject.monthgpgrowth 
                overallthisyeargpgrowth += changebrandobject.thisyeargpgrowth
                progresses.append(changebrandobject.progress)
                completemonths.append(str(changebrandobject.completemonth) if changebrandobject.completemonth else '--' )
                ...
                for eachdata in XEYBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
                    beforechangebrandmonthgp+=eachdata.monthgp
                for eachdata in XEYAfterChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if XEYSetStatus.objects.filter(overallid__id=i.id,is_active=True):
                setobject = XEYSetStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += setobject.monthgpgrowth 
                overallthisyeargpgrowth += setobject.thisyeargpgrowth
                progresses.append(setobject.progress)
                completemonths.append(str(setobject.completemonth) if setobject.completemonth else '--' )
                ...
                whygrowth+='套餐绑定,'
                setestgpgrowth=0      
                for eachdata in XEYSetDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
    ...
    field_purchasesum.short_description = '项目1-8月采购额'
...
#----------------------------
    ...
    def field_suppliertheoreticalgppercent(self, obj):
        ...
        return format_html('<div>{}</div>',  '{:.1%}'.format(value))
    field_suppliertheoreticalgppercent.short_description = '供应商理论毛利率'


#----------------------------


    @admin.display(ordering="purchasesum",description=format_html('项目1-8月<br>采购额'))
    def display_purchasesum(self, obj):
        return  '{:,.0f}'.format(obj.purchasesum)
    
    @admin.display(ordering="purchasesumpercent",description=format_html('该项目占<br>总采购额<br>占比'))
    def display_purchasesumpercent(self, obj):
        return  '{:.1%}'.format(obj.purchasesumpercent)
    

    @admin.display(ordering="theoreticalvalue",description=format_html('项目理论<br>销售额'))
    def display_theoreticalvalue(self, obj):
        return  '{:,.0f}'.format(obj.theoreticalvalue)

    @admin.display(ordering="theoreticalgp",description=format_html('项目理论<br>毛利润'))
    def display_theoreticalgp(self, obj):
        return  '{:,.0f}'.format(obj.theoreticalgp)
    
    @admin.display(ordering="theoreticalgppercent",description=format_html('项目理论<br>毛利率'))
    def display_theoreticalgppercent(self, obj):
        return  '{:.1%}'.format(obj.theoreticalgppercent)
    
#----------------------------

    @admin.display(ordering="supplierpurchasesum",description=format_html('供应商1-8月<br>采购额'))
    def display_supplierpurchasesum(self, obj):
        return  '{:,.0f}'.format(obj.supplierpurchasesum)
    
    @admin.display(ordering="purchasesumpercentinproject",description=format_html('项目中各<br>供应商采<br>购额占比'))
    def display_purchasesumpercentinproject(self, obj):
        return  '{:.1%}'.format(obj.purchasesumpercentinproject)
    

    @admin.display(ordering="suppliertheoreticalvalue",description=format_html('供应商理论<br>销售额'))
    def display_suppliertheoreticalvalue(self, obj):
        return  '{:,.0f}'.format(obj.suppliertheoreticalvalue)

    @admin.display(ordering="suppliertheoreticalgp",description=format_html('供应商理论<br>毛利润'))
    def display_suppliertheoreticalgp(self, obj):
        return  '{:,.0f}'.format(obj.suppliertheoreticalgp)
    
    @admin.display(ordering="suppliertheoreticalgppercent",description=format_html('供应商理论<br>毛利率'))
...
#新开项目状态
@admin.register(XEYNewProjectStatus)
class XEYNewProjectStatusAdmin(nested_admin.NestedModelAdmin):
...
#新开项目明细
@admin.register(XEYNewProjectDetail)
class XEYNewProjectDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
...
#供应商重新谈判状态
@admin.register(XEYNegotiationStatus)
class XEYNegotiationStatusAdmin(nested_admin.NestedModelAdmin):
...
#供应商重新谈判明细
@admin.register(XEYNegotiationDetail)
class XEYNegotiationDetailAdmin(nested_admin.NestedModelAdmin):
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        if db_field.name == 'productid': 
            kwargs["queryset"] = XEYMenu.objects.filter(is_active=True) 
        return super().formfield_for_foreignkey(db_field, request, **kwargs)
    ...
    @admin.display(ordering="recentsales",description=format_html('1-8月开票额'))
    def recentsales_display(self, obj):
        return '{:,}'.format(obj.recentsales)

    @admin.display(ordering="recentcost",description=format_html('1-8月采购额'))
    def recentcost_display(self, obj):
        return '{:,}'.format(obj.recentcost)

    @admin.display(ordering="recentgp",description=format_html('1-8月盈亏额'))
    def recentgp_display(self, obj):
        return '{:,}'.format(obj.recentgp)
    
    @admin.display(ordering="recentgpofsupplier",description=format_html('1-8月供应商<br>盈利额'))
    ...
    @admin.display(ordering="purchaseqty",description=format_html('1-8月采购<br>数量/单位'))
...
#渠道变更明细
@admin.register(XEYChangeChannelDetail)
class XEYChangeChannelDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换前明细
@admin.register(XEYBeforeChangeBrandDetail)
class XEYBeforeChangeBrandAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime','skuhistory')
    list_display_links=('progressid__overallid__project',)
...
#品牌替换后明细
@admin.register(XEYAfterChangeBrandDetail)
class XEYAfterChangeBrandDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
...
#套餐绑定明细
@admin.register(XEYSetDetail)
class XEYSetDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
    list_display = ('progressid__overallid__semidepartment','progressid__overallid__project','progressid__progress','originalsupplier','originalbrand',#newsupplier，beforeorafterbrandchange
                    'code','product','spec', 
...
@admin.register(XEYMenu)  
class XEYMenuAdmin(GlobalAdmin):   
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if 'autocomplete' in request.path:
            ...
            existed_redis_data = cache.get(username)
            if existed_redis_data:
                print(existed_redis_data,'class XEYMenuAdmin(GlobalAdmin): ~~~~~~~~~~~~~~~')
...
@admin.register(XEYOverallDELETE)
class XEYOverallDELETEAdmin(admin.ModelAdmin):
    exclude = ('id','createtime','updatetime','is_active','operator')
 ...
 #只显示未被假删除的项目
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=False,company_id=14)
    ...
    def restore(self, request, queryset):
        ...
        print('我在restore')      
        for i in queryset:
            # print(i.xeynewprojectstatusdelete_set.all())
            i.xeynewprojectstatusdelete_set.all().update(is_active=True)
            for j in i.xeynewprojectstatusdelete_set.all():
                if hasattr(j, 'xeynewprojectdetaildelete_set'):
                    j.xeynewprojectdetaildelete_set.all().update(is_active=True)

            i.xeynegotiationstatusdelete_set.all().update(is_active=True)
            for j in i.xeynegotiationstatusdelete_set.all():
                # print('~~~~~!',j)
                # print('all',j.xeynegotiationdetaildelete_set.all())
                if hasattr(j, 'xeynegotiationdetaildelete_set'):
                    # print("~~~~~hasattrxeynegotiationdetaildelete", j.xeynegotiationdetaildelete_set.all())
                    j.xeynegotiationdetaildelete_set.all().update(is_active=True)

            i.xeychangechannelstatusdelete_set.all().update(is_active=True)
            for j in i.xeychangechannelstatusdelete_set.all():
                # print('~~~~~~',j)
                if hasattr(j, 'xeychangechanneldetaildelete_set'):
                    # print("~~~~~", j.xeychangechanneldetaildelete_set.all())
                    j.xeychangechanneldetaildelete_set.all().update(is_active=True)

            i.xeychangebrandstatusdelete_set.all().update(is_active=True)
            
            for j in i.xeychangebrandstatusdelete_set.all():
                if hasattr(j, 'xeychangebranddetaildelete_set'):
                    j.xeychangebranddetaildelete_set.all().update(is_active=True)

            i.xeysetstatusdelete_set.all().update(is_active=True)
            for j in i.xeysetstatusdelete_set.all():
                if hasattr(j, 'xeysetdetaildelete_set'):
                    j.xeysetdetaildelete_set.all().update(is_active=True)

            if hasattr(i, 'xeycalculatedelete'):
                i.xeycalculatedelete.is_active=True
                i.xeycalculatedelete.save()  
            print('恢复') 
