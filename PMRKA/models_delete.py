...
class UserInfoPMRKADELETE(UserInfo):
...
class SalesmanPositionPMRKADELETE(models.Model):
    # id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('UserInfoPMRKADELETE', models.CASCADE, db_column='user',to_field='id') #settings.AUTH_USER_MODEL
    company = models.ForeignKey('CompanyDELETE', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_company_default_value)
...
class PMRResearchListPMRKADELETE(models.Model):
    # id = models.BigAutoField(primary_key=True)
    company = models.ForeignKey('CompanyDELETE', models.CASCADE, db_column='company',to_field='id',verbose_name= '公司',default=get_company_default_value)
    hospital = models.ForeignKey('HospitalDELETE', models.CASCADE, db_column='hospital',to_field='id',verbose_name= '医院')
    salesman = models.ForeignKey('UserInfoPMRKADELETE', models.CASCADE, db_column='salesman',to_field='id',related_name='salesmanPMRKADELETE',verbose_name= '填报人')
    ...
    relation=models.TextField(verbose_name='装机时间',max_length=255, blank=True, null=True)
    newold = models.CharField(verbose_name='业务类型',max_length=255, blank=True, null=True)

    operator = models.ForeignKey('UserInfoPMRKADELETE', models.CASCADE, db_column='operator',to_field='id',related_name='operatorPMRKADELETE',verbose_name= '最后操作人')
    createtime = models.DateTimeField(auto_now_add=True)
    updatetime = models.DateTimeField(auto_now=True)
    is_active=models.BooleanField(verbose_name='是否呈现',null=False, default = True)
    ...
    def delete(self, using=None, keep_parents=False):
        ...
        PMRResearchDetailPMRKADELETE.objects.filter(researchlist=self).update(is_active=False)
...
class PMRResearchDetailPMRKADELETE(models.Model):
    ownbusiness_choices = (
        (True, '是'),
        (False, '否'),)
    researchlist = models.ForeignKey('PMRResearchListPMRKADELETE', models.CASCADE, db_column='researchlist',to_field='id',verbose_name= '调研列表')
    ...
    relation=models.CharField(verbose_name='装机时间',max_length=255, blank=True, null=True)
