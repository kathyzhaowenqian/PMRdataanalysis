...
import xlwt
import io
from GONGWEI.tools.CalculateAPI import *
import os
from django.http import FileResponse
today = date.today()
folder_name1 = 'file'
folder_name2 = 'gw'
file_name = 'GongWei.xlsx'
    ...
    def post(self,request):
        ...
        #     # 使用 Pandas 读取 Excel 文件
            try:
                ...
                GONGWEI(uploaded_file,file_name)
        ...
        if request.user.username=='admin' or  request.user.username=='zwq8zhj' or  request.user.username=='cxy':  
            ...
            try:
                with open(file_path, 'rb') as f:
                    ...
                    response['Content-Disposition'] = 'attachment; filename=GongWeiCalculate.xlsx'
