...
from PUZHONGXIN.models_delete import *
...
#----------FORM-------LIST--------
class PZXOverallForm(forms.ModelForm):
...
class PZXNewProjectDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXNewProjectDetail
            exclude = ['id']
            widgets = {
...
class PZXNegotiationDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # print('aaaaaaaaaaaaaaaaaaaaaaaaaaa')
        self.fields['productid'].queryset =  PZXMenu.objects.filter(is_active=True)

    class Meta: 
            model = PZXNegotiationDetail
            exclude = ['id']
            widgets = {
...
class PZXChangeChannelDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  PZXMenu.objects.filter(is_active=True)

    class Meta: 
            model = PZXChangeChannelDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class PZXBeforeChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['productid'].queryset =  PZXMenu.objects.filter(is_active=True)

    class Meta: 
            model = PZXBeforeChangeBrandDetail
            exclude = ['id']
            widgets = {
                'productid': AutocompleteSelect(
                    model._meta.get_field('productid'),
...
class PZXAfterChangeBrandDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXAfterChangeBrandDetail
            exclude = ['id']
            widgets = {
                'originalsupplier': forms.TextInput(attrs={'size':'10'}),
                'originalbrand': forms.TextInput(attrs={'size':'5'}),
...
class PZXSetDetailInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class PZXNewProjectStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXNewProjectStatus
            exclude = ['id']
            widgets = {
...
class PZXNegotiationStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXNegotiationStatus
            exclude = ['id']
            widgets = {
...
class PZXChangeChannelStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXChangeChannelStatus
            exclude = ['id']
            widgets = {
...
class PZXChangeBrandStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
 
    class Meta: 
            model = PZXChangeBrandStatus
            exclude = ['id']
            widgets = {
...
class PZXSetStatusInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class PZXMenuforinlineInlineForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
#---------------------------------------------------------------
#新开项目明细的内嵌inline
class PZXNewProjectDetailInline(nested_admin.NestedTabularInline):
    form=PZXNewProjectDetailInlineForm
    model = PZXNewProjectDetail
    fk_name = "progressid"
    extra = 0
...
class PZXNewProjectStatusInline(nested_admin.NestedStackedInline):
    ...
    inlines=[PZXNewProjectDetailInline]
    model = PZXNewProjectStatus
    # fk_name = "overallid"
    extra = 0
...
#----------------------------------------------------------------
#供应商重新谈判明细的内嵌inline
class PZXNegotiationDetailInline(nested_admin.NestedTabularInline):
    form=PZXNegotiationDetailInlineForm
    model = PZXNegotiationDetail
    extra = 0
...
class PZXNegotiationStatusInline(nested_admin.NestedStackedInline):
    form=PZXNegotiationStatusInlineForm
    inlines=[PZXNegotiationDetailInline]
    model = PZXNegotiationStatus
    fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
class PZXChangeChannelDetailInline(nested_admin.NestedTabularInline):
    form=PZXChangeChannelDetailInlineForm
    model = PZXChangeChannelDetail
    # fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_recentsales','field_recentcost','field_recentgp','field_recentgpofsupplier','field_estmonthlygpgrowth')#'field_lissettleprice') 
...
class PZXChangeChannelStatusInline(nested_admin.NestedStackedInline):
    ...
    inlines=[PZXChangeChannelDetailInline]
    model = PZXChangeChannelStatus
    # fk_name = "overallid"
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
...
class PZXBeforeChangeBrandDetailInline(nested_admin.NestedTabularInline):
    form=PZXBeforeChangeBrandDetailInlineForm
    model = PZXBeforeChangeBrandDetail
    fk_name = "progressid"
    extra = 0
...
class PZXChangeBrandStatusInline(nested_admin.NestedStackedInline):
    form= PZXChangeBrandStatusInlineForm
    inlines=[PZXBeforeChangeBrandDetailInline,PZXAfterChangeBrandDetailInline]
    model =  PZXChangeBrandStatus
    extra = 0
    readonly_fields= ('thisyeargpgrowth','field_monthgpgrowthbydetail','field_thisyeargpgrowthbydetail') 
    fields=(('progress','completemonth'),
...
#-----------------------------------------------------------------
#套餐绑定明细的内嵌inline
class PZXSetDetailInline(nested_admin.NestedTabularInline):
    form=PZXSetDetailInlineForm
    model = PZXSetDetail
    fk_name = "progressid"
    extra = 0
    readonly_fields= ('field_estmonthlygpgrowth',) #'costfeepercent','marketpricefeepercent', 'newcostfeepercent') #'field_lissettleprice', 'field_recentgp',
...
#----------------------------------------------------------------
#该科室该项目大类的相关产品明细'
class PZXMenuforinlineInline(nested_admin.NestedTabularInline):
    model = PZXMenuforinline
    form=PZXMenuforinlineInlineForm
    # fk_name = "overallid"
    extra = 0
    # readonly_fields = ('estnewgpgrowth','realnewgpgrowth','newgpgrowthpercent',
    #                     'estnegogpgrowth','realnegogpgrowth','negogpgrowthpercent',
...
class PZXOverallAdmin(nested_admin.NestedModelAdmin):
    form = PZXOverallForm
    inlines=[PZXMenuforinlineInline,PZXNewProjectStatusInline,PZXNegotiationStatusInline,PZXChangeChannelStatusInline,PZXChangeBrandStatusInline,PZXSetStatusInline,PZXCalculateInline]
    exclude = ('id','createtime','updatetime','is_active','operator')
    search_fields=['department','semidepartment','project','supplier','pzxmenuforinline__product']
    ...
    #把项目的id放入redis，方便下面的PZXMENU来获取对应id的details
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        if not existed_redis_data:
            ...
            print(cache.set(username,existed_redis_data,None),'PZXOverallAdmin(nested_admin.NestedModelAdmin)')
    ...
    def delete_model(self, request, obj):
        ...
        if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or obj.salesman==request.user:             
            obj.is_active = False 
            obj.operator=request.user   
            if PZXNewProjectStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.pzxnewprojectstatus_set.all().update(is_active=False)
            if  PZXNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                PZXNewProjectDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if PZXNegotiationStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.pzxnegotiationstatus_set.all().update(is_active=False)
            if  PZXNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                PZXNegotiationDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if PZXChangeChannelStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.pzxchangechannelstatus_set.all().update(is_active=False)
            if  PZXChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                PZXChangeChannelDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if PZXChangeBrandStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.pzxchangebrandstatus_set.all().update(is_active=False)
            if  PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)
            if  PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True):
                PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=obj.id,is_active=True).update(is_active=False)

            if PZXSetStatus.objects.filter(overallid__id=obj.id,is_active=True):
                obj.pzxsetstatus_set.all().update(is_active=False)
    ...
    def delete_queryset(self,request, queryset):        
            ...
            for delete_obj in queryset:     
                ...
                if request.user.is_superuser or request.user.groups.values()[0]['name'] =='boss' or delete_obj.salesman==request.user:     
                    delete_obj.is_active=False
                    delete_obj.operator=request.user
                    if PZXNewProjectStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.pzxnewprojectstatus_set.all().update(is_active=False)
                    if  PZXNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXNewProjectDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if PZXNegotiationStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.pzxnegotiationstatus_set.all().update(is_active=False)
                    if  PZXNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXNegotiationDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  PZXChangeChannelStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.pzxchangechannelstatus_set.all().update(is_active=False)
                    if  PZXChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXChangeChannelDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if PZXChangeBrandStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.pzxchangebrandstatus_set.all().update(is_active=False)
                    if  PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    if  PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)
                    
                    if PZXSetStatus.objects.filter(overallid__id=delete_obj.id,is_active=True):
                        delete_obj.pzxsetstatus_set.all().update(is_active=False)
                    if  PZXSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True):
                        PZXSetDetail.objects.filter(progressid__overallid__id=delete_obj.id,is_active=True).update(is_active=False)

                    if  PZXCalculate.objects.filter(overallid__id=delete_obj.id,is_active=True):   
                        delete_obj.pzxcalculate.is_active=False
                        delete_obj.pzxcalculate.save()
                    delete_obj.save()
    ...
    def save_related(self, request, form, formsets, change): 
        ...
        for eachformset in formsets: #循环每一个增量来源及明细,删除多填的信息
            ...
            if eachformset.model==PZXNewProjectStatus:
                # print('eachformset-------PZXNewProjectStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=PZXNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=PZXNewProjectDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
            ...
            if eachformset.model==PZXNegotiationStatus:
                # print('eachformset------PZXNegotiationStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.form)
                statusobjs=PZXNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=PZXNegotiationDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()
                if statusobjs:
                    print('statusobjs[0]',statusobjs[0])
            ...
            if eachformset.model==PZXChangeChannelStatus:
                # print('eachformset-------PZXChangeChannelStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=PZXChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=PZXChangeChannelDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        statusobjs[i].delete()  
                if statusobjs:   
                    whygrowth+='渠道变更,'

            if eachformset.model==PZXChangeBrandStatus:
                # print('eachformset-------PZXChangeBrandStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=PZXChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=PZXBeforeChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)
                        detailobjs2=PZXAfterChangeBrandDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs2.update(is_active=False)
                        statusobjs[i].delete() 
                if statusobjs: 
                    whygrowth+='品牌替换,'

            if eachformset.model==PZXSetStatus:
                # print('eachformset-------PZXSetStatus------------=-=-=-=-=-=-',eachformset.cleaned_data)
                # print('eachformset.forms',eachformset.forms)
                statusobjs=PZXSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True)
                if len(statusobjs)>1:
                    for i in range(1,len(statusobjs)):
                        detailobjs=PZXSetDetail.objects.filter(progressid__id=statusobjs[i].id,is_active=True)
                        detailobjs.update(is_active=False)       
                        statusobjs[i].delete()  
                if statusobjs:
                    whygrowth+='套餐绑定,'
        ...
        for eachdetail in PZXNewProjectDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
        ...
        if  PZXNewProjectStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            newprojectobject= PZXNewProjectStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in PZXNegotiationDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            '''# print('eachdetail',eachdetail)
        ...
        if PZXNegotiationStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('negotiationobject',PZXNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            negotiationobject= PZXNegotiationStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in PZXChangeChannelDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code)            
            eachdetail.originalbrand=eachdetail.productid.brand
            eachdetail.spec=eachdetail.productid.spec
        ...
        if PZXChangeChannelStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changechannelobject',PZXChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changechannelobject= PZXChangeChannelStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            # print('eachdetail',eachdetail)
            eachdetail.product=str(eachdetail.productid.product)
            eachdetail.code=str(eachdetail.productid.code) 
            eachdetail.originalsupplier=eachdetail.productid.supplier
        ...
        for eachdetail in PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
        ...
        if PZXChangeBrandStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            print('changebrandobject',PZXChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True))
            changebrandobject= PZXChangeBrandStatus.objects.get(overallid__id=form.instance.id,is_active=True)
        ...
        for eachdetail in PZXSetDetail.objects.filter(progressid__overallid__id=form.instance.id,is_active=True):
            print('eachdetail',eachdetail)
            #costppl采购价/人份  = （采购价每单位 / 每单位人份数）
            eachdetail.costppl=eachdetail.costperunit/eachdetail.pplperunit
            #gppercent毛利率 （呈现%）  =  （LIS收费价 *  LIS结算%  -  采购价每单位 / 每单位人份数）/（LIS收费价 *  LIS结算%）
        ...
        if  PZXSetStatus.objects.filter(overallid__id=form.instance.id,is_active=True):
            setobject= PZXSetStatus.objects.get(overallid__id=form.instance.id,is_active=True)
      ...
      #CALCULATE 用销售填报的月毛利额增量预估来填：
        if PZXCalculate.objects.filter(overallid__id=form.instance.id,is_active=True):
            # print('原本有calculate：',PZXCalculate.objects.get(overallid__id=form.instance.id,is_active=True))
            a=PZXCalculate.objects.get(overallid__id=form.instance.id,is_active=True)
            a.estallgpgrowth=0
            a.estnewgpgrowth=0
            a.estnegogpgrowth=0    
            ...
            PZXCalculate.objects.create(**PZXCalculatedata).save()
        

        overallobject= PZXOverall.objects.get(id=form.instance.id)
 ...
 #新增动作————统计按钮
    ...
    def calculate(self, request, queryset):
        for i in queryset:
            ...
            relation=[]
            whygrowth=''
            if PZXNewProjectStatus.objects.filter(overallid__id=i.id,is_active=True):
                newprojectobject = PZXNewProjectStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += newprojectobject.monthgpgrowth 
                overallthisyeargpgrowth += newprojectobject.thisyeargpgrowth
                progresses.append(newprojectobject.progress)
                completemonths.append(str(newprojectobject.completemonth) if newprojectobject.completemonth else '--' )
                ...
                for eachdata in PZXNewProjectDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if PZXNegotiationStatus.objects.filter(overallid__id=i.id,is_active=True):
                negotiationobject = PZXNegotiationStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += negotiationobject.monthgpgrowth 
                overallthisyeargpgrowth += negotiationobject.thisyeargpgrowth
                progresses.append(negotiationobject.progress)
                completemonths.append(str(negotiationobject.completemonth) if negotiationobject.completemonth else '--' )
                ...
                for eachdata in PZXNegotiationDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if PZXChangeChannelStatus.objects.filter(overallid__id=i.id,is_active=True):
                changechannelobject = PZXChangeChannelStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changechannelobject.monthgpgrowth 
                overallthisyeargpgrowth += changechannelobject.thisyeargpgrowth
                progresses.append(changechannelobject.progress)
                completemonths.append(str(changechannelobject.completemonth) if changechannelobject.completemonth else '--' )
                ...
                for eachdata in PZXChangeChannelDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if PZXChangeBrandStatus.objects.filter(overallid__id=i.id,is_active=True):
                changebrandobject = PZXChangeBrandStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += changebrandobject.monthgpgrowth 
                overallthisyeargpgrowth += changebrandobject.thisyeargpgrowth
                progresses.append(changebrandobject.progress)
                completemonths.append(str(changebrandobject.completemonth) if changebrandobject.completemonth else '--' )
                ...
                for eachdata in PZXBeforeChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
                    beforechangebrandmonthgp+=eachdata.monthgp
                for eachdata in PZXAfterChangeBrandDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
            ...
            if PZXSetStatus.objects.filter(overallid__id=i.id,is_active=True):
                setobject = PZXSetStatus.objects.get(overallid__id=i.id,is_active=True)
                overallmonthgpgrowth += setobject.monthgpgrowth 
                overallthisyeargpgrowth += setobject.thisyeargpgrowth
                progresses.append(setobject.progress)
                completemonths.append(str(setobject.completemonth) if setobject.completemonth else '--' )
                ...
                whygrowth+='套餐绑定,'
                setestgpgrowth=0      
                for eachdata in PZXSetDetail.objects.filter(progressid__overallid__id=i.id,is_active=True):
...
#新开项目状态
@admin.register(PZXNewProjectStatus)
class PZXNewProjectStatusAdmin(nested_admin.NestedModelAdmin):
...
#新开项目明细
@admin.register(PZXNewProjectDetail)
...
#供应商重新谈判状态
@admin.register(PZXNegotiationStatus)
class PZXNegotiationStatusAdmin(nested_admin.NestedModelAdmin):
...
#品牌替换后明细
@admin.register(PZXAfterChangeBrandDetail)
class PZXAfterChangeBrandDetailAdmin(nested_admin.NestedModelAdmin):
    exclude = ('id','createtime','updatetime')
    list_display_links=('progressid__overallid__project',)
...
@admin.register(PZXMenu)  
class PZXMenuAdmin(GlobalAdmin):   
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if 'autocomplete' in request.path:
            ...
            existed_redis_data = cache.get(username)
            if existed_redis_data:
                print(existed_redis_data,'class PZXMenuAdmin(GlobalAdmin): ~~~~~~~~~~~~~~~')
...
@admin.register(PZXOverallDELETE)
class PZXOverallDELETEAdmin(admin.ModelAdmin):
    exclude = ('id','createtime','updatetime','is_active','operator')
 ...
 #只显示未被假删除的项目
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        if request.user.is_superuser :
            return qs.filter(is_active=False,company_id=7)
