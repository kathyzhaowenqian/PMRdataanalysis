...
class PZXgantt(View):
    ...
    def post(self,request):
        ...
        NewProjectStatus_queryset = PZXNewProjectStatus.objects.values('statushistory').filter(is_active=True)
        NegotiationStatus_queryset = PZXNegotiationStatus.objects.values('statushistory').filter(is_active=True)
        ChangeChannelStatus_queryset = PZXChangeChannelStatus.objects.values('statushistory').filter(is_active=True)
        ChangeBrandStatus_queryset = PZXChangeBrandStatus.objects.values('statushistory').filter(is_active=True)
        SetStatus_queryset = PZXSetStatus.objects.values('statushistory').filter(is_active=True)
